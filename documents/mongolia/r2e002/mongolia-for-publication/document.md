...
Mongolian Institute of Education
...
The global citizenship education (GCED) and/or education for sustainable development (ESD) objectives  and  policies  are  promoted  nationally  in  Mongolia.  In  pre-primary,  primary  and secondary, higher education sub-levels include GCED or ESD policies to some extent. These sustainable developmental goals are included in national goals through the Ministry of Education and Science, through Government of Mongolia both short and long term development plan/vision, with  the  support  of  developmental  partners  and  non-governmental  organizations  (NGOs) operating  in  the  country.  The  GCED  and  ESD  themes  are  explicitly  mentioned  in  national educational laws and policies.
...
Specifically,  in  the  Mongolia's  long-term  development policy document - Vision 2050 and the education  sector  mid-term  development  plans.  The  aforementioned  themes  are  explicitly mentioned  and  highlighted  as  desired  objectives  in  the  pre-primary,  primary  and  secondary, higher education levels nation-wide.

Mongolian sustainable development goals cam be found through the following link http://sdg.gov.mn/Home/About
...
The recently approved and endorsed Education Sector Mid-Term Development Plan 2021-2030 promote GCED and ESD themes which are explicitly mentioned. These goals are integral part of the plan and in includes pre-primary, primary and secondary, higher education level around the country.
...
Mongolia's long-term development policy document - Vision 2050, Mongolian Education Sector Mid-Term Development Plan 2021-2030 (ESMTDP 2021-2030) Sustainable Development Goals of Mongolia http://sdg.gov.mn/ Government of Mongolia Action Plan for 2020-2024 https://www.legalinfo.mn/annex/details/11219?lawid=15586
...
The  current  ESMTDP  2021-2030  highlight  equal  opportunity  to  access  quality  education  by scaling up the inclusive education system, quality and relevance of the education system and services. Specifically, modifying curriculum content of all education levels to reflect culture and tradition, discipline, formation of character and development of individual and scientific skills that can compete at the global stage. Improvements in the kindergartens and schools capacity and promotion of equitable access. Open education services to be diversified. All kindergartens and schools will have a enabling environment to include special needs children. Equality and quality of  education  opportunities  shall  be  provided  to  all  citizens  regardless  of  their  developmental needs, location and lifestyle. These are the themes that have been included in the developmental policy that the Ministry of Education and Science has set as objectives and have implemented at all sub-levels of education levels nation-wide.

Education for Sustainable Development themes are integrated in the Government of Mongolia Development plan and its components are required to be part of the national and sub-national curriculum.
...
The GCED/ESD goals of equality, human rights, environmental sustainability peace and non-violence, cultural diversity and tolerance are themes that are mainstreamed and implemented nation-wide.

In pre-primary, primary and secondary education levels the ESD themes are covered and integrated as part of the curriculum the following links demonstrates with related legal frameworks in the pre-primary, primary and seconary education level curriculum content. It includes themes such as cultural diversity and tolerance, gender equality, peace and non-violence environmental sustainability and health and wellbeing. http://www.mier.mn/wp-content/uploads/2020/09/sub_zuvlumj.pdf

http://www.mier.mn/%d0%b1%d0%b0%d0%b3%d0%b0-%d0%b1%d0%be%d0%bb%d0%be%d0%b2%d1%81%d1%80%d0%be%d0%bb

http://www.mier.mn/%d1%81%d1%83%d1%83%d1%80%d1%8c-%d0%b1%d0%be%d0%bb%d0%be%d0%b2%d1%81%d1%80%d0%be%d0%bb

http://www.mier.mn/wp-content/uploads/2019/09/%D0%90%D0%A5%D0%9B%D0%90%D0%A5.pdf
...
GCED/ESD themes are integrated in initial training and continuing professional development of teachers,  trainers  and  educators.  For  example,  the  initial  training  for  all  teachers  have  some qualities  of  GCED/ESD  such  as  human  rights,  equality,  non-violence  and  aggression  and throughout  their  professional  career  it  is  required  by  law  to  continuously  improve  their development and training.  These  training  session  and  opportunities  does  include  GCED/ESD themes to reach the sustainable development goals of the Vision 2050.
...
The following link shows the legal and ethical and moral standards and requirements for teachers for all sub-levels of education. The GCED/ESD themes such as the human rights and non-violence, equality and diversity are integrated in the national law.

https://www.legalinfo.mn/annex/details/8470?lawid=13384

In the above law, it requires all teacher of all educational sub-levels to continuously improve their capacity and training. Indeed, throughout their professional career, the school and the Ministry of Education and Science regularly provide teacher training sessions and opportunities to improve their capacity. For example, there are activities and trainings for teachers who work with children with disabilities to provide and include them in the educational curriculum without discrimination. It also included in the national ESMTDP 2021-2030.

Through  teacher  training  institute  http://itpd.mn/article/c/1  continuously  provides  training  and professional development curriculum and sessions that have integrated the ESD themes in it. The institute often works with non-governmental organizations that foster and enhance sustainable development goals such as environmental sustainability, recycling, climate change and personal development. http://itpd.mn/article/361
...
GCED/ESD themes are included in the student curriculum and during assessments and examinations such topic as environmental sustainability, human rights are tested. During the course of the academic year, especially in primary and secondary education sub-levels, students are assessed based on their attitudes, values and behavior, where unacceptable demonstration of behavior and values will lead to more attention to that student including consultation with their parents.

Most of ESD themes are covered in student assessments and examinations as the curriculum would have covered such themes.
...
In 2019 the TVET Assessment Centre and Regional Methodological centres were restructures in one institution. Its function is to carry out competency-based training (CBT) assessments and quality assurance of training institutions. Moreover, its objective is to develop teachers and implement CBT system. Although, there are numerous challenges in its full implementation, the TVET enhanced access will provide support to people with special needs and enable flexible learning pathways. Teachers will have improved in relation to labour market needs and the requirements of the Industrial Revolution 4.0
...
Numerous ESD themes are highlighted and tackled as projects through their respective Ministries, non-governmental organizations and national agencies. For example, the National Committee on Gender Equality is carrying out a “Combating Gender-Based Violence” project with close cooperating with Swiss development agency and UN Population fund to reduce gender-based violence, including domestic violence and to strengthen national capacity to prevent and respond to violence. https://www.gender.gov.mn/news-detail/427?lang_id=2
...
The support from the Asian Development Bank major research and studies where carried our nation-wide to assess the current educational situation and its challenges. The outcome of such studies where instrumental in designing the ESMTDP 2021-2030.
