...
Irish society has incorporated many of the 1974 Recommendation, promoting gender equality, legislation to eradicate discrimination on grounds of ethnicity, sexual orientation, etc. The Equal Status Act of 2000 is a central pillar in this reform agenda. In specific educational legislation the Educational Act 1998 An Act to make provisions in the interest of the common good for the education of Every Person in the State, including any person with disabilities or who has other special educational needs, and to provide generally for primary, post-primary, adult and continuing education and vocational education and training; to ensure that the education system is accountable to students, their parents and the State for the education provided, respects the diversity of values, beliefs, languages and traditions in Irish society and is conducted in the spirit of partnership between schools, patrons, students, parents, teachers and other school staff, the community served by the school and the State; to provide for the recognition and funding of schools and their management through boards of management; to provide for an inspectorate of schools, to provide for the role and responsibilities of principals and teachers; to establish the national council for curriculum and assessment and to make provisions for it, and to provide for related matters.

This has helped transform the transparency and partnerships in education, recognising the rights and obligations of school leaders and managers, parents and students and aligning education with the values of modern Ireland.

#### A1b Please provide the full names of any laws, legislation or legal framework referred to in A1 and were possible web links to relevant documents.

Equal Status Act 2000    Equal Status Act

Educational Act 1998     Educational Act 1998

The Education (Admission to Schools) Act 2018  Education Admissions to Schools Act 2018

The National Strategy on Education for Sustainable Development 2014-2020

An audit of the primary and post primary curricula for opportunities and linkages to ESD was published in 2018:  https://ncca.ie/media/3573/esdreport_final_june2018.pdf
...
Sustainable development themes and principles are integrated across the Irish school curriculum at all levels specifically:

At Early Years (0-6years), Aistear is the curriculum framework in Ireland. It provides information for adults to help them plan for and provide enjoyable and challenging experiences so that all children can grow and develop as competent and confident learners within loving relationships with others. The curriculum explores and promotes the concept of citizenship and social justice with children and respects them as young citizens: A new draft Primary Curriculum Framework, published by the National Council for Curriculum and Assessment for public consultation in February 2020, includes 'Active Citizenship' as a key competency aimed at fostering within children the knowledge, skills, concepts, attitudes, values and dispositions that motivate and empower them as citizens to take positive actions to live justly, sustainably and with regard for the rights of others. It helps children question, critique and understand what is happening in the world within a framework of human rights, equality and social justice. It places democratic practices at the centre of the learning process. This competency develops children's capacity and motivation for active and meaningful participation in society at local, national and global levels, and fosters their ability to contribute positively and compassionately towards the creation of a more sustainable and just world.

The Junior Cycle Framework (2015) includes 12 statements of learning which encompass valuing what it means to be an active citizen, with rights and responsibilities in local and wider contexts and the awareness, knowledge, skills, values and motivation to live sustainably.

Wellbeing has also been a key aspect of the Junior Cycle Framework. The Department of Education published a Wellbeing Policy and Framework for practice (2018-2023 ), outlining a comprehensive, whole-school approach to the promotion of wellbeing and the academic, physical, mental, emotional, social and spiritual development of all children and young people. It focuses on the whole school community, as well as groups and individual young people with identified needs.
...
Our revised Primary Languages curriculum aims at making language learning more cohesive in the early years of ISCED 1, which, fosters greater linguistic and intercultural understanding.
...
The Department of Education has also cooperated with other government departments to promote and reinvigorate reform. For example, there is an overarching Public Service Reform Plan 2014 to 2016. We support the Department of Children, Equality, Disability, Integration and Youth Better Outcomes Brighter Futures - the National Policy Framework for Children & Young People 2014-2020 and have been significantly influenced by the Department of Health's Healthy Ireland: A Framework for Improved Health and Wellbeing 2013 to 2025, an initiative which aims to improve the health and wellbeing of people living in Ireland. The department is represented on a number of groups including the National Physical Activity Plan Implementation Group and on the Obesity Policy Implementation Oversight Group. All of these initiatives, and more, have resonance with the 1974 Recommendation.

A fundamental tenet of the Irish higher education sector is the principle of academic freedom which is shared by all institutions. The sector fully subscribes to the principles outlined in the UNESCO recommendation  in  terms  of  ensuring  that  all  individuals  or  groups  are  treated equally and that there should be no discrimination "based on sex, race, colour, ethnic or social origin,  religion  or  belief,  political  or  any  other  opinion,  membership  of  a  national  minority, disability, age or sexual orientation".

The sector in its teaching and research provides a range of courses and research opportunities that expand our knowledge in the areas of human rights and fundamental freedoms.   Such courses can be found in the areas of, inter alia, human rights, politics, law, environmental science,  agriculture,  medicine,  sociology,  education,  communications,  police  studies  and other related areas.

The Irish Centre for Human Rights is located at the National University of Ireland Galway.  It is one of the world's premier university-based institutions for the study and promotion of human rights and humanitarian law. Since its establishment in 2000, the Centre has developed a global reputation for excellence in the field of human rights teaching, research and advocacy.

Endorsing the principle that all citizens have a fundamental right to access higher education, the National Office for Equity of Access to Higher Education (from 2014 the National Access Policy  Office)  was  established  in  the  Higher  Education  Authority  in  2003  to  facilitate educational  access  and  opportunity  for  groups  who  are  under-represented  in  higher education. The overall goal of access policy in higher education is that the student population in our higher educational institutions will reflect the diversity of Ireland's population at large.
...
The Student Grant Scheme provides supports to qualifying full-time students in further and higher education. The move to a centralised system for the administration of student grants was part of a wider programme of administrative and legislative reform These are underpinned by the Student Support Act 2011

The means-test of the Student Grant Scheme is a fundamental element of the student grant administration process. It is the mechanism that identifies whose income is to be considered for grant assessment purposes. It is key to ensuring that the scheme is equitable and is targeted appropriately.

The student support scheme is the key policy intervention to support access to further and higher education. The term 'access' is generally understood to comprehend entry into further and/or higher education, the retention of students within the system and their successful completion; so that the student can develop to his or her full potential.

The main aims of the scheme is to:

- Provide a contribution towards the cost of further or higher education in order to assist as many students as possible to obtain one qualification at each level of study (undergraduate and postgraduate). This enables individuals to develop their full potential through further and higher education and participate fully as members of society, which will contribute to Ireland's social, cultural and economic development.

- Target funds at those identified as 'most in need' of assistance through terms and conditions of funding, including means-testing. The Student Grants Scheme, including means-testing arrangements, are kept under review to ensure that the available funding is targeted equitably and towards those who require assistance the most.

- Promote equality/equity of access to further and higher education in order to ensure participation rates reflect the general population/wider society. The provision of student grant supports assist in addressing the financial barriers to enter, participate in and successfully complete further and higher education, thereby ensuring that the student body at all levels reflects the diversity and social mix of Ireland's population.

Under the Erasmus+ programme, all participating Irish higher education institutions agree to subscribe to 'respect in full the principles of non-discrimination set out in the Programme and ensure equal access and opportunities to mobile participants from all backgrounds.
...
Development Education takes place across a wide range of formal, non-formal and informal 4 settings, and involves learners of all ages. Development Education activities can take place within the remit of a structured project or can be delivered by individual teachers or leaders on an ad hoc basis. The sections that follow refer to some, but by no means all, of the projects taking place in Ireland, with an emphasis on the work of IDEA members

Please see Irish Development Association Educational Association (IDEA) Submission regarding UNESCO report on 1974 Recommendations and Development Education in Ireland Report

#### A3b

https://www.ideaonline.ie/

> 4   The  boundaries  between  'formal',  'non-formal'  and  'informal'  education  can  be  fluid.  For  basic  definitions  see  http://www  oecd org/edu/skills-beyondschool/recognitionofnon-formalandinformallearning-home htm.
...
#### B1a. Please describe in which ways GCED and ESD are mainstreamed in school curricula. Indicate whether topics are taught as standalone subjects or are integrated into the curricula of other subjects. Explain whether GCED and/or ESD themes 5  are mentioned explicitly or are inferred and what types or levels of education are covered.

Curriculum reforms in recent years have included revisions at ISCED 2 to incorporate civic education within the 'wellbeing' area of learning (2015), including a wellbeing framework (2018-2023) which supports an integrated curriculum planning approach to the provision of courses on wellbeing, based on the belief that civic participation is a key part of a student's wellbeing, just as social and health education are. Work continues to revise the specifications for these curricular areas at this level. The introduction of Politics and Society at ISCED 3 gives a prominence and importance to civic, environmental and sociological education, and helps to link ISCED 3 to third level education opportunities much more strongly than before.

The Department of Education published its National Strategy on Education for Sustainable Development (ESD) 2014-2020 and an interim review of the strategy in 2018.  It will develop a follow on strategy for ESD to 2030 during 2021 in consultation with key stakeholders, to align with the UN Sustainable Goals Target 4.7 and with UNESCOs Framework for ESD for 2030.

The Department has also published anti-bullying procedures for schools (2013), and strongly supports Children First (2011) our national child protection strategy. In addition, the Education (Student and Parent Charter) Bill, 2019 aims to improve how schools engage with students and their parents.
...
Politics, Society and Wellbeing, including CSPE and SPHE are covered under the curricula.
...
Including the above mentioned, Irish Aid runs the 'Our World' programme, a national awards scheme for primary schools. The Our World programme was established to raise awareness among Irish primary pupils of the UN Millennium Development Goals.

The An Taisce Environmental Education Unit, in partnership with Local Authorities throughout the country, operates the 'Green-Schools' international environmental education programme. in Ireland (more than 90% of all Irish schools) are currently participating in the programme and over  3,100  schools  have  been  awarded  the  Green  Flag,  making  the  Irish  Green-Schools programme one of the most successful within the international network. Three of the eight themes within the Green-School programme are linked to 'Global Citizenship'.

The  Irish National Teachers  Organisation (INTO)  runs a Global Citizenship  School programme, which supports primary schools to learn about and act on global issues. The programme provides lesson plans, resources, and suggestions for possible actions to take as follow-ons from learning about global rights and responsibilities.

A number of International Development NGOs run programmes for the primary classroom. Trócaire runs a 'Better World' Awards programme for primary pupils, recognising creative responses to their annual Development Education Lenten Resource, which in 2017 focused on climate change. The popular Concern Debates programme for post-primary school has been extended into the upper classes at primary level, encouraging pupils to develop public speaking, research and language, skills and to gain a deeper understanding of Global issues affecting millions of people.
...
--- | ---
GCED/ESD are taught as separate subject(s) | 1 (Politics, Society and Wellbeing, including CSPE and SPHE)
Cross-curriculum approach ( e.g. GCED/ESD are taught in more than one subject but not throughout the curriculum ) | 1 (Yes)
Integrated approach ( e.g. GCED/ESD are taught throughout the whole curriculum ) | 1 (Yes)
Whole school approach (e.g. GCED/ESD are integrated in the school ethos, management, governance, curriculum, teacher training, teaching practices, the learning environment and in learning experiences in the community and life outside school ) | 1 (Yes)
...
The DICE (Development and Intercultural Education) Project is a national education initiative, funded  through  a  Strategic  Partnership  with  Irish  Aid,  which  promotes  and  supports  the integration of Development Education and Intercultural Education in Initial Teacher Education at primary level in Ireland. The Project is implemented by four higher education institutions and works to support teacher  educators  and student teachers  within  these  institutions,  to integrate global and intercultural perspectives and themes into their teaching practice and wider university/school environments., DICE seeks to promote global solidarity, human rights and environmental awareness, and to support people to recognise and challenge discrimination and inequality, globally and locally.
...
There has been an increased emphasis on inclusion throughout the FET System. Fostering Inclusion is one of the three core pillars around which the Further Education and Training Strategy (FET) 2020-2024 is built and is embedded in the strategy along with the additional pillars of  building skills and creating pathways.   The FET sector is committed to increasing levels of inclusion through the provision of high quality, more accessible and flexible education and training programmes and supports suited to the identified needs of individuals, and proactively addressing systemic and structural barriers within FET to learner participation and success, with the aim of enabling every citizen to participate fully in society.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
Initial or pre-service training | 1 | 1 | 1 | 1
...
Continuing professional development | 1 | 1 | 1 | 1
For teachers of selected subjects only (in which GCED or ESD are typically taught) | 1 | 1 | 1 | 1
...
Global citizenship and education for sustainable development
--- | ---
GCED/ESD are taught as separate subject(s) | 1 (Politics and Society and Wellbeing, including CSPE and SPHE)
Cross curriculum approach ( e.g. GCED/ESD are taught in more than one subject but not throughout the curriculum ) | 1 (Yes)
Integrated approach ( e.g. GCED/ESD are taught throughout the whole curriculum ) | 1 (Yes)
Whole school approach (e.g. GCED/ESD are integrated in the school ethos, management, governance, curriculum, teacher training, teaching practices, the learning environment, and in learning experiences in the community and life outside school ) | 1 (Yes)
...
The revised Junior Cycle  Framework  places  an  increasing  the  emphasis  on  skills, competencies, values and behaviours, as well as increasing the role of formative assessment as a means of promoting and deepening student learning. Current revisions to specification in wellbeing subjects set out that assessment of the wellbeing subjects at ISCED 2 will be done through classroom based assessments and not at state examination level.
...
1. | Cultural diversity and tolerance | 1 | 1 | 1 | 1
2. | Gender equality | 1 | 1 | 1 | 1
3. | Human rights | 9 | 1 | 1 | 1
4. | Peace and non-violence | 9 | 1 | 1 | 1
5. | Climate change | 9 | 1 | 1 | 1
6. | Environmental sustainability | 9 | 1 | 1 | 1
7. | Human survival and well-being | 9 | 1 | 1 | 1
8. | Sustainable consumption and production | 9 | 1 | 1 | 1
...
Some GCED and/or ESD themes 7  are mainstreamed. Select this option if GCED is mainstreamed but ESD is not (or vice versa).
...
(b) | Curricula | 9 | 1 | 1 | 1
(c) | Teacher education | 1 | 1 | 1 | 1
(d) | Student assessment | 9 | 1 | 1 | 1
Sub-national
(a) | Education laws and policies | 1 | 1 | 1 | 1
(b) | Curricula | 1 | 1 | 1 | 1
(c) | Teacher education | 1 | 1 | 1 | 1
...
A number of courses relevant to the 1974 UNESCO Recommendation are provided in adult and further education, but at the discretion of individual providers rather than as a State provision.

Resources include those developed by the department's agencies and support services such as, NCCA, JCT, NCSE and PDST as well as those provided by NGOs and various national initiatives which focus on human rights etc.

Note: the Department of Education does not produce or revise textbooks in Ireland. These are produced by commercial companies, but are guided by the Department's specifications and syllabi.  Schools can determine which text books to use, if any, to best support their delivery of the curriculum in their own context.
...
SOLAS, the Further Education and Training Authority of Ireland, Education and Training Boards Ireland (ETBI), and the 16 Education and Training Boards (ETBs) across the country have progressed a series of actions to support the goal of Fostering Inclusion through the development and roll-out of a series of good practice guidelines to promote inclusion throughout FET. This includes the development of a conceptual framework for Universal Design for Learning (UDL) for the FET Sector. This approach aims to reduce obstacles to learning by taking into account the needs of learners of diverse backgrounds and abilities. Once in place, this will help all learners in FET, whatever their particular needs, and will make FET as widely accessible as possible.

The  Further  Education  and  Training  (FET)  system  seeks  to  support  the  inclusion  of all individuals,  particularly  marginalised  individuals  or  communities,  to  participate  in  further education and training, and to enable every individual to fully participate in society. It strives to ensure that systemic and structural barriers within FET to learner participation and success are proactively addressed so that each learner can access the available learning opportunities and be enabled to fulfil his/her potential within FET.

As part of the annual FET service planning process that takes place between SOLAS and the Education and Training Boards (ETBs), ETBs are required to consider the needs of a broad range of learners and marginalised groups; these groups include but are not limited to women, migrants,  members  of  the  Traveller  and  Roma  Communities,  members  of  the  LGBTQ+ Community,  asylum  seekers,  people  with  disabilities,  people  from  lower  socio-economic groups.  And  through  their  quality  assurance  agreements  with  Quality  and  Qualifications Ireland (QQI) ETBs promote inclusive learning environments.
...
There is no data that can be drawn upon to give statistical evidence of these. In most schools, the co-curricular and extra-curricular programmes contain aspects of the principles and topics mentioned earlier and the system uses a range of media to promote good practice and values (wellbeing, adult literacy, counteracting bullying and anti-social behaviour).

Ireland is making substantial and consistent progress in promoting the 1974 Recommendation through education. In recent times the emphasis has focused on curricular reform and on the modernisation of pedagogy to create an optimum learning environment for students, where speaking and listening to each other, appreciating different views and cultures and a deepening understanding of rights and responsibilities is standard.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
Hosting of international meetings on GCED and/or ESD | 0 | 9 | 1 | 1
...
Membership of international networks including ASPnet | 9 | 9 | 1 | 1
Joint research projects on GCED and/or ESD with foreign institutions | 9 | 9 | 1 | 1
...
Due to a number of operational difficulties, the European Studies Programme which had fostered a number of the practices above at ISCED 2 and 3, has been discontinued. However, our post-primary schools continue to encourage student exchanges, links with schools abroad (supporting language learning and greater understanding). Increased broadband across the country delivered under the National Broadband plan will augment such opportunities further in even small rural schools
...
The years 2012-2022 form a decade of centenaries and mark a very important decade in Irish history. It has seen a vast range of commemorative events and activities, but the decade has also had a very substantial focus on reflection and reimagining. By this, we mean using the springboard of historical understanding to encourage new thinking in our society - e.g. promote North-South understanding, social justice, equal rights, embracing the new multicultural Ireland and so on. At the time that the 1974 Recommendation was drawn up, these ideas were little more than aspirations. Today, they have a very concrete basis in Ireland and the decade of centenaries programme has done a huge amount to reinforce the vision.
...
In addition, in 2020 students were part of the stakeholder consultations in relation to the adaption of the state examinations due to Covid 19, and they will be part of this process again in 2021.
