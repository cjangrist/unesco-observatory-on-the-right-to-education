...
MARA, KEMAS, RISDA, PERDA & KEDA - formal education, JAKOA - non-formal education
...
- Secondary School Standard Curriculum or Kurikulum Standard Sekolah Menengah (KSSM) ;
...
- Polytechnic and Community College Strategic Plan 2018 - 2025
...
https://www.moe.gov.my/menumedia/media-cetak/penerbitan/dskp-kssr
...
1. | Cultural diversity and tolerance | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
2. | Gender equality | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
3. | Human rights | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
4. | Peace and non-violence | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
5. | Climate change | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
6. | Environmental sustainability | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
7. | Human survival and well-being | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
8. | Sustainable consumption and production | 1 | 1 | 1 | 1 | 1 | 1 | 0 | 1
...
In Malaysia, GCED and ESD are not taught as subjects, but aspects of sustainable development and global citizenship  are  integrated  in  the  Primary  School  Standard  Curriculum (KSSR)  and Secondary  School  Standard  Curriculum  (KSSM).  The  protection  of  the  environment,  climate change and other aspects of sustainable consumption and production are incorporated across the curriculum that aim to raise awareness and develop positive attitudes among the students.
...
The third shift of this plan namely Nation of Lifelong Learners is in line with the SDG 4 agenda that all learners acquire the knowledge and skills needed to promote sustainable development, including,  among  others,  through  education  for  sustainable  development  and  sustainable lifestyles.

The system aspirations for higher education are in alignment towards developing an inclusive and equitable quality education. The five system aspirations cover Access, Quality, Equity, Unity and Efficiency . Each system aspiration has corresponding key indicators which the MOHE use to track the progress of outcomes.

###### Access

As Malaysia aspire to have one of the most educated and skilled workforce in the region, higher education enrollment rate is targeted to be more than 70%, Master and PhD enrollment rate to be more than 8% by 2025, to be on par with the highest enrollment levels in the Association of Southeast  Asian  Nations  (ASEAN).  This  will  require  an  additional  1.1  million  places  mainly through growth in the Technical and Vocational Education and Training (TVET), private HLIs and online learning.  Enrollment for TVET in 2019 is 245,908 (35.6%).
...
MOHE aims to ensure equity in higher education, giving every student the opportunity to fulfil his or her full potential regardless of location, race, sex or socio economic background. Similarly, the Ministry  recognizes  the  important  of  providing  equitable  access  to  education  opportunities  for special need due to disabilities.  (Enrolment for students with disabilities 2019 is at 1791 (0.14%). With more pressing demands for an inclusive higher education for the disabled persons, in 2012, MOHE had issued an Instruction for Implementation of Action Plans to Improve Teaching and Learning  for  Students  with  Disabilities  (OKU)  at  all  Public  Universities.  This  instruction  for implementation of action plans was used in determining/deciding the best practices of inclusive education that comply with international standards, which to be implemented at the university level throughout  the  country.  This  consequently  led  to  the  formulation  of  a  Guideline  for  the Implementation of the Policy for Persons with Disabilities Inclusion in HEIs in 2019.  MOHE will regularly review student outcome data on performance gaps, and is committed to improve the enrolment  rate and  completion  rate of  students  from  socio-economically  disadvantaged backgrounds and communities.

###### Unity

Given Malaysia's multi-ethnic society, MOHE aspires to create an education system that provides students  with  shared  values,  shared  experiences,  and  common  aspirations  by  embracing diversity.  Patriotism and Unity Index has been developed in 2017 to indicate the level of unity, including  the  degree  of  general  trust  among  ethnic  groups,  the  extent  of  religious  and  racial tolerance, and social interaction between students of different communities. The goal is to develop talent that can contribute towards creating a cohesive society from among diverse communities, whether in neighbourhoods, local communities, schools, universities, or workplaces.
...
The Rural Development Policy 2030(RDP 2030) has summarised the "Prosperous, Inclusive, Sustainable and Holistic Rural Living" vision as the main agenda of rural development approach in Malaysia by 2030. Through the RDP 2030, the Government is highly committed to reduce and eventually  eliminate  the  gap  between  urban  and  rural  communities  in  terms  of  quality  of  life, creating economic opportunities as well as providing a conducive social environment to motivate rural communities especially the youths to remain in the rural area.

The vision of RDP 2030 is 'Prosperous Rural Living', which creates thriving rural communities in various aspects; including social, economy, culture and environment. This vision will ensure that the development will benefits all, regardless of race, religion, social status, gender and age. The target of 'Prosperous Rural Living' vision is to ensure a balanced and sustainable development that complements each other in social, economic and environmental aspects.

The policy statement is developed in accordance with the 10 thrusts of rural development that support RDP 2030's vision and mission. The related thrusts promoted GCED & ESD as follows:

###### 1. THRUST 03: EXCELLENT HUMAN CAPITAL

Excellent,  viable  and  sustainable  rural  human  capital;  and  fulfilling  future  human resources need through an excellent quality education system.

###### 2. THRUST 05: EMINENT RURAL YOUTH

Empowerment of rural youths with outstanding personality as well as knowledgeable, highly-skilled,  patriotic,  creative,  innovative,  and  enjoy  sustainable  income  through entrepreneurship.

###### 3. THRUST 06: PROGRESSIVE RURAL WOMEN

Rural women that are advanced in all aspects of life, including in economy, education, health, social and leadership.

###### 4. THRUST 09: BIODIVERSITY AND SUSTAINABLE ENVIRONMENT

Preservation and conservation of biodiversity and environment through a sustainable development approach; Enhancing community awareness and responsibility as well as promoting an environmental- friendly way of life.

Strategies indicate for related thrusts as follows:
...
The Rural Development Policy 2030 (RDP 2030)
...
Textbook development | 1 | 1 | 0 | 99
Teacher education and training | 1 | 1 | 1 | 99
Assessment of student outcomes | 1 | 1 | 1 | 99
Sub-national
Design or revision of the curricula | 1 | 1 | 0 | 99
Setting of programme learning objectives | 1 | 1 | 0 | 99
Textbook development | 1 | 1 | 0 | 99
...
GCED and ESD are not taught as standalone subjects. They are embedded and integrated in the school curricula  in  all  subjects  at  all  levels.  Elements  of  climate  change  like  protection  of  the environment, global warming and greenhouse effect, sustainable consumption and production are incorporated across the curriculum.

In 2019 Civics Education was reintroduced, focusing on good citizenry in the context of self, family, school,  community  and  global  -  integrated  through  teaching  and  learning  in  the  classroom, extracurricular, weekly assembly and school activities.
...
Curriculum in polytechnics and community colleges is designed and responded to the learning outcome clusters that aligned to the aspirations of National Education Philosophy. The learning clusters prescribe personal and ethical competencies that build up characters of the graduates of polytechnics and college communities to be good and functional citizens.

DPCCE also has shown dedication to the SDGs and green technology through the curriculum design  and  implementation  at  the  institutions.  Blueprint  POLYGreen  2015-2020  (BPPM)  and Blueprint SmartGreen Polytechnic Community College 2021-2026 (BSGPC) are published to be used by all institutions.

The  elements  of  ESD  and  GCED  are  taught  to  all  students  of  polytechnics  and  community colleges  in  Malaysia  through  general  studies  courses.  General  studies  courses  are  made compulsory for all students to enroll and pass. These courses highlight the values of embracing world cultures and to function in today's society.
...
Another example is in the Geography subject for Form One (grade 7). The element of climate change is introduced as part of the Learning Objectives and Learning Outcomes under the theme 'The Influence of Weather and Climate '.

[[END OF PAGE 17]]

[[START OF PAGE 18]]

The elements of climate change for example, are also integrated in other subjects like languages and other social  study  subjects  to  further  enhance  students'  knowledge  and  skills  on  climate change from the cultural and heritage perspectives. Religious and faith-based approaches also highlight  the  importance  of  earth  preservation  as  reflected  in  the  religious  studies  and  Moral subject.

More recently, MoE Malaysia embarked on the pilot project to embed GCED elements through project- based learning in four subjects - History, Geography, Maths and Science.
...
- Blueprints on Smart Green can be referred at https://smartgreen.mypolycc.edu.my
...
Elements of Education for Sustainable Development (ESD) and Global Citizenship Education (GCED) are included in the teacher training curriculum. Human rights, sexuality education and human governance  are  integrated  in  all  teacher  training  programs  offered  by  the  Institute  of Teacher Education (ITE).

##### MOHE

To ensure the MPU modules are delivered at HEIs as prescribed by the MPU guidelines, a series of  Training  of  Trainers  (TOT)  has  been  conducted  from  time  to  time  for  MPU  teachers  and lecturers  at  HEIs.  The  TOTs  include  how  to  effectively  deliver  content  and  case  studies  with embedded  elements  of  GCED  and  ESD,  through  active  learning  session  and  project-based assignment, which are then assessed based on the stipulated course learning outcomes. The TOTs also share good and best practices in delivering MPU courses even in the situation of a large class size.

As for Polytechnic and Community College the element of ESD and GSED are emphasis to all DPCCE  lecturer  through  teaching  competency  certificate  @  Instructional  Leadership  and Andragogy Development Course [Kursus Kepimpinan Instruksional dan Pembangunan Andragogi (KIPA)].

The courses will equip lecturers with technical and vocational education skills and knowledge which is parallel with the national education needs and the industry standard practice.

Lecturers will also be trained to lead their institutions and engage with the stakeholders based upon the rules and regulations as stated in national standards and policies.

Regular  upskilling  and  refresher  courses  will  ensure  lecturers  are  highly  skilled  in  applying technology to improve the efficiency and skills training needs of industry and country

Lecturers are expected / encouraged to adhere to code of ethics and professional conduct when dealing with the stakeholders, communities and industries.
...
The Teacher Institute of Education Malaysia (ITE/IPGM) has developed a guideline namely 'Garis Panduan  Pembangunan  dan  Semakan  Kurikulum  Institut  Pendidikan  Guru'  (Guidelines  for Development and Review of Teacher Education Curriculum) in 2019. The guidelines are built to ensure that all programs offered by ITE/IPGM are designed and reviewed according to current educational needs and requirements.

##### MOHE

The dominant teaching-learning techniques recommended during the TOT training sessions for delivering  MPU  courses  are  based  on  'high  impact  educational  practices'  (HIEP)  originally introduced  by  American  Association  of  Colleges  and  Universities  (AACU),  where  these techniques were adapted for implementation for Malaysian context by the HIEPs taskforce from at MOHE as well as another taskforce for HIEPS for MPU. As inculcation of elements of GCED and ESD requires certain level of student engagement with their subject, their peers and their facilitators, the adoption of HIEP has been found to be effective in guiding the student to attain the course learning outcomes.
...
For teachers of selected subjects only (in which GCED or ESD are typically taught) | 1 | 1 | 0 | 9
...
Student assessments and examination in HEIs consist of these elements:
...
Meanwhile, student assessment and examination in Polytechnic and Community College of Malaysia assess students' knowledge and skills related to the topics being tested as well as assessing students' values, attitudes and/or behaviours.
...
--- | --- | --- | --- | ---
National
(a) Education laws and policies | 1 | 1 | 2 | 1
(b) Curricula | 2 | 2 | 2 | 1
(c) Teacher education | 2 | 2 | 1 | 1
(d) Student assessment | 1 | 1 | 2 | 1
Sub-national
(a) Education laws and policies | 1 | 1 | 0 | 1
(b) Curricula | 2 | 2 | 0 | 1
(c) Teacher education | 2 | 2 | 0 | 1
(d) Student assessment | 1 | 1 | 0 | 1
...
- Community Service Component - as part of the TVET programme where students are given the space to develop their social, communication and leadership skills. The component will provide opportunity for students to function as an individual as well as community members - understand, appreciate and take positive actions in the community through project-based initiatives. Teaching and learning will be conducted in the form of interactive lectures, group discussions, experience-based learning through group activities and volunteerism.

- Innovation of the AQUAFERA by one of the vocational colleges - produced from Moringa olifera extract, termanilia cattapa dan fermented bacteria to stabilize water and soil pH level and, to treat waterborne diseases - as part of sustainable environment

- The introduction of sustainable urban farming as part of Siswapreneur Innovation Challenge 2019 (Young Entrepreneur Innovation Challenge for Undergraduate 2019).
...
There are many research that has been carried out by MOHE to improve the implementation of Education for Sustainable Development. The Ministry of Higher Education (MOHE) always supports and encourages quality basic research which contributes in areas of importance to the Malaysian economy and society.

This includes research that enhances the quality of education in promoting peace and human rights. MOHE's Fundamental Research Fund Program (Program Dana Penyelidikan Fundamental KPT) covers four (4) main grant schemes:

(i) Fundamental Research Grant Scheme (FRGS);

(ii) Prototype Research Grant Scheme (PRGS);

(iii) Transdisciplinary Research Grant Scheme (TRGS); and
...
- A TVE Stakeholder Defined Curricular Framework for Education for Sustainable Development (ESD): Reorienting TVE teacher training Programmes for Sustainability Education.

- Formulating the Education Ecosystem Efficiency Index, EEEI by extending aboriginal worldview theory in the context of Orang Asli in Malaysia.

- Establishing Therapeutic Landscape Model for Children with Learning Disabilities in Malaysia berjumlah RM 63,100 oleh penyelidik USM Tahun 2020.

- Exploring  Gender-Responsive  Dimensions  for  STEM  Teachers:  Towards  Developing  a Fundamental Gender-Responsive Framework.

Besides, MyPAiR programme was established in year 2019. The MyPAiR program is one of the initiatives outlined under the Eighth Strategy and is the implementation of the Second Focus 2019 Budget initiative which ensure's the wellbeing of Malaysians. This program aims to enhance research cooperation between Higher Education Institutions (HEIs) with local industries as well as international agencies  in  strategic  areas.  MyPAiR  was  introduced  to  strengthen  the  capabilities  and  drive Malaysian research excellence through strategic partnerships and collaborations.

Research sharing and collaboration is not limited to sharing expertise but also covers a wider concept. Malaysia has the appropriate capacity to embark on a broader network of research collaborations. The principles of financing MyPAiR are in the form of matching funds, research scope and genuine collaboration. Total allocation so far has reached RM30,000,000.00 through one off allocation in year 2019.  Among  the  success  story  of  MyPAiR  is  establishing  research  cooperation  relations  with countries such as the United Kingdom, Japan, France, and Spain. This brings capacity development into  a  broader  context  at  a  international  level.  Various  international  technology,  information  and expertise exchange, opportunity to use such facilities among the most advanced laboratories in the world.

Researchers can participate in attachment programs at collaborative partner universities.  Expanding domestic research: ensuring Malaysian R&D is relevant and remains competitive globally. This can help strengthen the strategic relationship between countries through the exchange of knowledge, experience, and technology in the scientific and technical fields that will benefit researchers in higher education institutions, departments, agencies and industries in the country. This opens up creation of profitable green opportunities which could attract investment opportunities from outside companies especially from collaborative partner countries such as Japan. Besides, this international research collaboration  also  helps  in  developing  synergies  between  the  research  communities  to  create  a structured and sustainable research network that is of high standard and internationally recognized.

Ministry  of  Higher  Education  also  actively  invest  in  various  research  promoting  activities  such  as establishing The Higher Institution Centers of Excellence (HICoE). This Programme is  implemented by the Department of Higher Education to drive IPT research excellence in niche research. Through this  programme, Department of Higher Education gives HICoE rating to the Center of Excellence (CoE) which is of high performance in the field of niche research.

[[END OF PAGE 29]]

[[START OF PAGE 30]]

Recognized HICoE has immediate impact on the production of new research talents, the publication of high-impact journals as well as the production of innovations that can benefit academia, industry, government, community and environment. Periodic performance monitoring will be carried out to ensure implementation in line with the objectives of the HICoE program as well as a basis for the subsequent distribution of HICoE research funds.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
Hosting of international meetings on GCED and/or ESD | 0 | 0 | 1 | 9
...
- Constraints on teachers' time within the apparently overcrowded curricula, GCED and ESD are usually conceptualised by many teachers as 'add-ons', rather than a holistic change in teaching and learning practices.

- Focus on pen and paper scores in the national exams which in some ways impede the holistic approach to GCED and ESD although current efforts by the education sector to move to a more holistic assessment - the SBA.

- The challenge to get commitments from all levels of the community NOT only from teacher to ensure a more profound impact at all levels since GCED and ESD are transformative and nurturing in the implementation process.
...
- The COVID19 pandemic has highlighted the importance to further strengthen efforts to build  teachers'  and  students'  resilience  through  continuous  communication  in  raising awareness, understand the risks across sectors, reaching consensus and building trust.

- COVID-19 have also raised concerns about the overall mental well-being of children and youth. The Ministry of Education (MoE) in collaboration with the Ministry of Health (MoH) has embarked on a programme called Student's Mental Well-Being in the New Normal to promote  positive  mental  health  of  all  students  and  to  respond  to  specific  well-being concerns and issues during this challenging time. While traditional academic skills are important,  COVID-19  has  highlighted  the  importance  to  further  strengthen  efforts  to develop cognitive, social, emotional and behavioural skills to ensure children are resilient in this crisis - the most in-demand skills that today's learners need in a rapidly changing world.
