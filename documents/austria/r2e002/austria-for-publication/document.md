...
Federal  Ministry  of  Education,  Science  and  Research;  Federal  Ministry  of  Climate  Action, Environment, Energy, Mobility, Innovation and Technology; Austrian Development Agency
...
Advisory board on Transformative Education at the Austrian National Commission for UNESCO; Strategy Group Global Learning/Global Citizenship Education; Center for Migration, Multilingualism and Human Rights Education (Ko.M.M.M.) at the University College

Other civil society organizations (please specify):

Environmental  Umbrella  Organisation;  ÖKOBÜRO  (Alliance  of  the  Austrian  Environmental Movement)

Others (please specify) :

Austrian Ecolabel for Educational Institutions; Forum Environmental Education ; CliMates Austria; JUMP platform (youth platform); Sustainability Forum Illmitz
...
Pre-Primary Education : With regard to the constitutional distribution of competencies in Austria according  to  Art.  14  Para.  4  lit.  b  of  the  Federal  Constitutional  Act,  the  responsibility  for  the legislation and enforcement in matters of elementary education lies with the federal states. They regulate  the  framework  conditions  for  institutions  for  early  childhood  education  and  care  and finance  them  accordingly.  However,  since  2008  the  federal  government  has  been  investing continuously in the expansion of the early childhood education and care area as well as in the compulsory contribution-free kindergarten year before entering school as well as in early language support on the basis of an Art. 15a B-VG agreement between the federal government (Bund) and the regional authorities (Länder).  The curriculum of the educational institutions for elementary education (BAfEP) promotes GCED as well as ESD themes.

Primary/Secondary Education (including Vocational Education): Schools also have responsibilities to educate and inform about topics that cannot be allocated to individual subjects. Account must be taken of these as teaching principles in the teaching of as many subjects as possible. The purpose of such principles of instruction is to help attain those educational tasks of school  which  require  an  interdisciplinary  cooperation  of  several  subjects  of  instruction.  All teachers as well as school supervisory boards and administrations are invited to promote an effective  implementation  of  all  cross-curricular  educational  principles  into  their  educational practice.

Teaching  principles  apply  to all school  levels  and  all  types  of  school  and  ensure  an interdisciplinary approach. Their contents are regulated by so called basic decrees. The features of  the  tasks  and  issues  dealt  with  by  these  teaching  principles  are  the  ability  to  draw  on  life experiences, to see things clearly and to solve problems. These skills allow pupils to acquire knowledge independently in wider contexts.

The following teaching principles are related to the themes outlined in this consultation:
...
·Reflexive gender education and equality
...
Health Promotion does not only include information on health issues and the influence on the behaviour of the individual, but also the design of a health-promoting living space.
...
Intercultural Education as a teaching principle empowers teachers and students to respectfully deal with diversity in a multicultural society. The according general ordinance (2017) refers to the international  framework,  i.e.  the  2030  Agenda  and  its  Sustainable  Development  Goals,  the UNESCO Guidelines on Intercultural Education etc.

Citizenship Education - including its global dimension of Citizenship Education -
...
Environmental  Education  for  Sustainable  Development is  strongly  linked  to  other  teaching principles such as Economic and Consumer Education and Road Safety Education . Environmental education contributes to a sustainable development of society and highlights how the complex interaction of various social influences has led to the current state of our environment. It can strengthen awareness, a sense of responsibility, and the skills which allow pupils to shape their  future.  Environmental  education  promotes  the  acquisition  of  competences  needed  to understand the finiteness of our natural resources, and contributes to shaping the environment and society in a forward-looking manner, based on solidarity and responsibility.

Tertiary: Universities  Act  Among  the  guiding  principles  to  be  observed  by  the  universities  in pursuance of their objects are: gender equality; equality of opportunity; special attention to the needs of the handicapped; reconciliation of study/work with child care and care of dependents (§2).

Several technical and organisational requirements are regulated through the Universities Act, e.g. the establishment of an organisational unit responsible for the coordination of activities relating to equal opportunities, the advancement of women and gender research; a career advancement plan for women and an equal opportunities plan; the duty of career advancement for women; working groups on equal opportunities responsible for combating gender discrimination as well as discrimination on the basis of ethnicity, religion or conviction, age, or sexual orientation by university  governing  bodies  and  for  advising  and  supporting  the  university's  members  and governing bodies in connection with these issues. Universities have to report on gender equality indicators in the context of an annual intellectual capital report.

Amendment (2018) to the Universities Act --> Sustainable Development is to be integrated into the  performance  agreements  2019-2021  between  Universities  and  the  Federal  Ministry  of Education, Science and Research (0,5% of the overall budget can be retained by the federal minister).

[[END OF PAGE 10]]

[[START OF PAGE 11]]

To ensure the implementation of measures for the social dimension in teaching as well as the inclusion of underrepresented groups into HE, the federal minister can retain up to 0,5% of the overall university budget.

University  of  Applied  Sciences  Act  and  Private  Universities  Act Universities  of  Applied Sciences and Private Universities are required to give regard to gender equality and a balanced representation of the sexes in all positions and offices, to present an equal opportunities plan and to report on gender equality measures.

Hochschulgesetz (Federal Act on the University Colleges of Teacher Education) Gender mainstreaming  is  mandatory  for  university  colleges  of  teacher  education;  duty  of  Career Advancement  for  Women;  working  groups  on  equal  opportunities  responsible  for  combating gender discrimination as well as discrimination on the basis of ethnicity, religion or conviction, age, or sexual orientation by governing bodies and for advising and supporting the members and governing bodies in connection with these issues.

In impact-oriented management of public administration, planning is done in the form of yearly budget targets, with performance indicators to assess the success of the measures. Attention is paid in particular to the actual equality of women and men, which plays an essential role in this process. In addition, Austria applies the instrument of impact assessment to ensure that goals and measures are defined for all regulatory or larger endeavours of the Federal Government and that the impacts on concrete policy areas are systematically assessed.

In  the  assessments  in  individual  policy  areas  (impact  dimensions),  there  are  major  content overlaps  with  the  SDGs,  for  instance  in  the  equality  of  women  and  men  and  in  measures concerning  the  environment  and  climate  action.  Impact  assessment  is  therefore  a  tool  that increases the transparency, traceability and coherence of policy decisions in favour of sustainable development.

Overarching: The Federal Development Cooperation Act (Entwicklungszusammenarbeitsgesetz, EZA-G, 2002) is the national legal basis for the Austrian Development Agency's (ADA's) funding strategy 'Development Communication and Education in Austria'.
...
Curriculum of the educational institutions for elementary education (BAfEP) https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=20009623

General Ordinance on Health Promotion

https://www.bmbwf.gv.at/Themen/schule/schulrecht/rs/1997-2017/1997_07.html

General Ordinance on Intercultural Education
...
Pre-Primary Education: The compulsory cross-state educational framework plan (BildungsRahmenPlan) conveys content of ESD as well as GCED. The application of the "Living Values, Creating Values. Building of Values in Early Childhood Education and Care Institutions" manual is mandatory. It teaches children through interfaith education and diversity pedagogy important values of living together, such as respect, equality and tolerance. This makes an important contribution to Global Citizenship Education.

Primary/Secondary (including Vocational Education): Educational Concerns extend beyond the structural content of individual school subjects and take account of overarching themes that are important for pupils' personal development and lifestyles, and are also socially relevant. Educational concerns complement the formal interdisciplinary teaching principles (see A1a). Several of them are related to the scope of this consultation, such as Global Learning/Global Citizenship Education, Development Education and Education for Sustainable Development (not to be confused with Environmental Education for Sustainable Development, which is one of the teaching principles, see above).
...
Within the framework of the National Action Plan for Entrepreneurship Education, sustainable Entrepreneurship Education is pursued in accordance with the SDGs.  As physical education in school is concerned, the goals at
...
Sub-national
Design or revision of the curricula | 0 | 9 | 99 | 9
Setting of programme learning objectives | 9 | 1 | 99 | 1
Textbook development | 9 | 99 | 99 | 99
Teacher education and training | 9 | 1 | 99 | 1
Assessment of student outcomes | 9 | 1 | 99 | 1
...
Primary/Secondary: For  teachers, curricula form the basis for their independent, responsible teaching and educational work. It is teachers' duty to help individual pupils achieve the objectives specified  in  the  curriculum  through  suitable  lesson  planning  and  design.  The  curricula  also mention the importance of transdisciplinary approaches and the fact that school is a place of social experience,  where  it  should  be  possible  to  deal  with  global  topics,  differing  opinions  and alternative  approaches  in  experimental  and  creative  ways.  In  addition,  school  is  a  sort  of microcosm of society shaped by cultural and social diversity and therefore facilitates learning to deal with societal heterogeneity, conflicts and differing interests and generally to live in a world of diversity.

In addition to the cross-curricular approach mentioned under A1a and A1b, GCED and ESD are also part of the curricula of various subjects in all school types at all levels.  In "History, Social Science and Citizenship Education" (grade 6-8), modules with longitudinal and cross-sections are provided for dealing with historical and political topics. The lessons should -according to the connection between global, continental, national, regional and local aspects -give an insight into the history and politics of different areas, make their interconnectedness clear and thus relate in particular to intercultural and global learning.

Through school-autonomous curriculum regulations, additional emphases can be set on themes regarding this consultation in the form of optional subjects and non-binding exercises. School networks such as the Austrian members of the ASPnet, ÖKOLOG schools, Fairtrade schools, e.e.si Entrepreneurship schools, Climate Alliance schools and schools awarded with the Austrian Ecolabel set thematic priorities regarding the scope of this consultation.

Tertiary: Austrian universities have, from the start, accepted the challenges of sustainability and education for sustainable development and have involved these in their curricula (in reference to university governance, § 1 UG 2002).
...
Ethics/moral studies | 9 | 1 | 9 | 9 | 9 | 9 | 9 | 9
Geography | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 1
Health, physical education and sports | 1 | 1 | 9 | 1 | 1 | 1 | 1 | 1
History | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 9
Languages | 9 | 9 | 1 | 1 | 9 | 9 | 9 | 9
Mathematics | 9 | 9 | 9 | 9 | 9 | 9 | 9 | 9
Religious education | 1 | 9 | 1 | 1 | 9 | 9 | 9 | 9
Science | 9 | 9 | 9 | 9 | 1 | 1 | 9 | 9
...
Primary and secondary: Teachers in Austria are being trained through tertiary bachelor's and master's  programmes  (ISCED  6  and  7)  at  universities  and  university  colleges  of  teacher education. These cooperate as part of four regional development alliances throughout Austria to ensure that students can choose from the respective regional, jointly established study offers within an alliance.
...
Teachers of secondary-level general education choose two fields of study or one field of study and  one  specialisation (e.g. inclusive teaching, social  pedagogy;  multilingualism,  media education).

The  educational  objectives  and  training  areas  are  set  out  in  the  respective  federal  laws (Universities Act 2002, Act on the Organisation of University Colleges of Teacher Education, Act on Quality Assurance in Higher Education) by means of framework specifications (according to Federal Act on the New Teacher Training Scheme).

The  detailed  design  of  the  curricula  is  the  responsibility  of  the  educational  establishments, therefore the curricula for teacher training programmes have different emphases. The topic of Global Citizenship is present in several teacher training curricula for primary education, secondary general education and vocational education.

University  colleges  of  teacher  training  offer  demand-oriented  courses  and  in-service  training seminars  at  schools  and  across  schools  as  well  as  specific  university  courses.  The  broad spectrum of content includes in particular human rights education and peace education, but also environmental education, globalisation and sustainability, which take into account topics such as climate change, biodiversity and consumer behaviour.

[[END OF PAGE 21]]

[[START OF PAGE 22]]

A special focus is placed on the 2030 agenda. Some university colleges of teacher education engage as ÖKOLOG school network partners.   Currently, there is a lack of chairs for gender related subjects in Austria. Consequently, just occasional modules are provided.
...
The University College of Teacher Education Salzburg is offering a course in Reflexive Gender Education.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | --- | ---
1. | Cultural diversity and tolerance | 1 | 0 | 1 | 0
2. | Gender equality | 1 | 1 | 1 | 1
3. | Human rights | 1 | 0 | 1 | 0
4. | Peace and non-violence | 1 | 1 | 1 | 1
5. | Climate change | 1 | 1 | 0 | 1
...
Pre-primary education teacher students are assessed not only on their knowledge and skills but also on their values, attitudes and behaviours regarding GCED as well as ESD themes. The focus lies on GCED. This happens on the one hand in the course of the admission interviews and on the other hand in the course of their work at the practice kindergartens. The prospective staff is being observed during the training period.

Primary/secondary: Whether students' competencies and knowledge relating to gender equality, gender stereotypes and history of gender is assessed or not, depends on the respective teachers.

In tertiary education, student assessments are based on knowledge and skills related to the topics being tested.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
1. | Cultural diversity and tolerance | 1 | 9 | 0
2. | Gender equality | 1 | 0 | 0
3. | Human rights | 1 | 9 | 0
4. | Peace and non-violence | 1 | 9 | 0
5. | Climate change | 1 | 9 | 0
6. | Environmental sustainability | 1 | 9 | 0
...
--- | --- | --- | --- | --- | ---
National
(a) | Education laws and policies | 1 | 2 | 1 | 9
(b) | Curricula | 1 | 1 | 1 | 9
(c) | Teacher education | 1 | 1 | 1 | 1
(d) | Student assessment | 1 | 0 | 1 | 9
Sub-national
(a) | Education laws and policies | 9 | 9 | 99 | 9
(b) | Curricula | 9 | 1 | 99 | 9
(c) | Teacher education | 9 | 1 | 99 | 9
(d) | Student assessment | 9 | 9 | 99 | 9
...
80% of the 15 to 19 years old students attend TVET schools providing technical and/or vocational training in addition to a broad general education.  The teaching principles and educational concerns outlined in section A also apply to teaching at TVET schools.

The National Action Plan of Entrepreneurship Education pursues sustainable Entrepreneurship Education in accordance with the SDGs. e.e.si (Entrepreneurship Education for Innovation at School) is a school network for VET schools (schools of business administration). In an Entrepreneurship School, measures to encourage entrepreneurial thinking, personality forming and education towards responsible citizens (TRIO model) are an integral part of teaching and day-to-day school life. Entrepreneurship education and school development should move forward jointly and include all school stakeholders.

The SDGs are important points of reference for e.e.si schools.  The Entrepreneurship Summit is the main event of the annual Global Entrepreneurship Week in Austria. Recent summits had a strong focus on the SDGs.

GCED and ESD topics are mainstreamed in all curricula of VET teacher education. Some additional examples:  Master's programme in secondary vocational education and training with a focus on 'Sustainability Management in Health and Nutrition': Education for Sustainable Development is implemented in interdisciplinary projects. There is an emphasis on democratic responsibility and action.

Impact: In the context of their master's theses, students develop and implement sustainable concepts in VET. In-service VET teacher training include manifold offers related to GCED and ESD topics, e.g. -Intercultural competences -Interculturality in everyday school life -Global Goals and Solving Challenges - Learning with the UN Model -Living sustainability - What can I do, what can WE change together? -Already changing the world today? - How teachers can work for climate justice. and many more.

The SPAR Academy Vienna (SPAR's vocational school for apprentices) together with the World Wildlife Fund created the Green Champions Apprentices Programme for a Sustainable Future. The aim is to empower apprentices from the food retail trade to become actively involved in the discourse of global environmental goals and also to act as multipliers in their social environment. Link: https://www.wwf.at/de/spar-akademie
...
The Austrian Lifelong Learning Strategy - LLL:2020 is an instrument to look at different actions at various stages of learning, from early childhood education and care to school and higher education, continuing/adult education and training and education in the post-professional phase of life. The strategy is based on five guidelines which complement each other (life stage orientation, focus on learners, lifelong guidance, competence orientation, promotion of participation in lifelong learning). In all guidelines gender equality and social justice, quality, sustainability, efficiency and innovation are taken into consideration. The strategy pursues a holistic approach, which cannot only be reduced to educational issues, but incorporates different policy areas of education, integration, the labour market, economy as well as social, financial and regional issues and aims at concerted action.
...
Austria is a Member of the Schools for Health in Europe network foundation (SHE) https://www.schoolsforhealth.org/

The UniNEtZ project aids inter- and intra-university networking and the integration of the SDGs in areas of university life such as research, teaching, student initiatives, management and administration, and aims over the long term to make a significant contribution to sustainable development in Austria. https://www.uninetz.at/
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
Hosting of international meetings on GCED and/or ESD | 0 | 1 | 1 | 1
Participation in international meetings abroad on GCED and/or ESD | 0 | 1 | 1 | 1
Support for programmes hosting foreign students, researchers and/or teachers | 0 | 0 | 1 | 9
Membership of international networks including ASPnet | 0 | 1 | 1 | 1
Joint research projects on GCED and/or ESD with foreign institutions | 0 | 1 | 9 | 9
...
The Covid-19 pandemic has had major implications on the education system and has disrupted tertiary education; most of the teaching was moved online and some Higher Education Institutions have reported that measures to promote the social dimension have been delayed. Evidence suggests a re-traditionalisation and a global backlash concerning gender equality affecting the education system (resistance, polarisation, erosion of rights referring to the freedom of religion etc.) Re-traditionalisation of gender roles and gender based violence is reinforced in the context of the current COVID pandemic.
...
Experts of the Advisory Board on Transformative Education at the Austrian National Commission for UNESCO consider the definitions of GCED and ESD used in this questionnaire as not appropriate to represent the spirit and the very idea of GCED and (to a minor degree) of ESD.
