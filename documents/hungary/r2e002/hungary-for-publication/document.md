...
Permanent Representation of Hungary to OECD and UNESCO
...
Ministry of Human Resources; Ministry of Innovation and Technology
...
Hungarian Rector's Conference; various higher education institutions
...
In  Hungary,  the  Constitution  in  force  from  2011  declares  the  responsibility  towards  future generations and collaboration for sustainable development as shared national values in Hungary: this frames ESD approach in all legislative frameworks, strategies and policy documents in the country.

The Constitution that governs the organization of public education and defines its basic principles is the Act CXC of 2011 on National Public Education. In Section 1. of the Act among the Purpose and Principles it is stated that 'the whole of public education is determined by knowledge, justice, order,  freedom,  fairness,  the  moral  and  intellectual  values  of  solidarity,  equal  treatment  and education for sustainable development and healthy lifestyle. Public education shall universally serve the common good as well as private objectives respecting the rights of others.' As the Act does  not  contain  specific  content  regulations,  actual  topics  such  as  GCED  or  ESD  are  not mentioned explicitly, however underlying the whole approach of the Act.

The Act covers pre-primary, primary and secondary education. Also, it guarantees the didactical freedom for teachers that 'based on the pedagogical program, they choose the content and the methods of education'.

Hungary's International Development Cooperation Strategy for the period 2014-2020 and for the period 2020-2025 covers GCED principles in Hungary. The point 1.8 of the Government Decree no. 1182/2014 of III.27. states the responsibilities of the ministers of foreign affairs and education to collaborate for introducing and implementing GCED in formal education in Hungary. The 12§ of the XC/2014. Law on International Development Collaboration and International Humanitarian Aid highlights the importance of GCED and establishes collaboration between the MFA and the Ministry of Human Capacities (responsible for education) in Hungary in the field of awareness raising and global education.

The National Core Curriculum (hereinafter: NCC) is issued as a government decree (Gov. decree no. 110/2012 of I. 31.) that is why it is mentioned here as reference. However, as it is by definition a curriculum, further details concerning the NCC see point A3a.

The Act 2011/CCIV on national higher education carries some of the contents referred to in point A2. The same and other relevant contents are published with more details in 18/2016. (VIII. 5.) Ministry of Human Capacities decree, which provides the training and output requirements of all undergraduate and master's programs in Hungarian tertiary education.
...
The Fundamental Law of Hungary (referred as the Constitution of Hungary): https://njt.hu/translated/doc/TheFundamentalLawofHungary_20190101_FIN.pdf
...
Hungary's International Development Cooperation Strategy for the period 2020-2025: https://nefe.kormany.hu/download/8/2f/92000/NEFE2025_summary_en.pdf

Government Decree on International Development Cooperation no. 1182/2014 of III.27;
...
Economic Strategy (2019-2030, Ministry of Innovation and Technology)
...
The main objective of NFSSD is to achieve knowledge needed towards transition to SD, in order to ensure 'the creation of an education-training-development system (and cultural institutions), which enhances values, moral standards, social quality, emotions, community attachment, ability for systematic approach, as well as ensures knowledge, skills and competences required on the labour market, the evolvement of new forms of social learning and the need for lifelong learning'.

Although the Hungarian titles of the other relevant policy documents refer to environmental education, their content covers the ESD topics: the fourth National Strategy for Environmental Education serves as an implementation plan for ESD: it is prepared and periodically revised by NGOs. The National Environmental Program also serves as an implementation plan. The term 'environmental education' is often used in a wider context, referring to ESD in Hungary.
...
At strategic levels, relevant strategies share the same vision on sustainability and ESD. Such relevant policy documents include: the National Sustainable Development Frame Strategy; the National Sustainable Development Strategy; the National Sustainable Development Strategy Second Progress Report (2015/2016, prepared in 2017); the Hungarian National Lifelong Learning Strategy; the Hungarian National Youth Strategy; the Hungarian Higher Education medium-term Strategy: 'A Change of Pace in Higher Education'.

The implementing regulations of the new Act on National Higher Education (2011) enable the introduction of sustainability issues for any courses, trainings and higher education courses at any level. All higher education institutions may start new programmes and courses dealing with (at least partly) SD.  Implementation belongs to higher education institutes. An analysis of Output Criteria shows that many disciplinary and interdisciplinary courses deal with SD and ESD. More than 50 MSc courses demonstrate a strong SD component; mostly among the competence goals, less among educational aims (of the Output Criteria).

Non-formal and informal ESD is addressed in the National Framework Strategy on Sustainable Development and in the 4th National Environmental Program (chapter 6.1) as well as in the National Environmental Education Strategy. Specific dimensions of ESD are apparent in the various national strategies in the field of environmental protection, climate change or water management, such as the 4th National Environmental Programme, the National Development 2030 - National Development and Territorial Development Concept, the National Strategy for the Conservation of Biodiversity in 2015-2020, the Second Climate Change Strategy of Hungary for 2014-2025 with an outlook to 2050, the National Nature Conservation Master Plan, the National Rural Development Strategy 2012-2020, the National Water Strategy, the National Forestry Strategy 2016-2030 and the National Landscape Strategy 2017-2026.
...
Digitalization is an undoubtable pre-requisite of achieving the goals in 4.7 in GCED/ESD. In 2016 the Government of Hungary adopted the Digital Education Strategy of Hungary (DES). One of the most important goals of the strategy is to provide students with appropriate digital competences and get them prepared for Life Long Learning. Another goal of the DES is to ensure that a sufficient amount of digital contents are available in an up-to-date learning environment. To provide teachers with the opportunities to gain the necessary digital methodological knowledge as well as the provision of the necessary infrastructure (network and devices) in schools.

In the course of the implementation of the DES the development of broadband internet network and Wi-Fi systems have been carried out starting in 2018. The resources allocated for these developments add up to 26 billion forints till the end of 2019. The state funds the operation, the continuous development and expansion of the National Educational Portal (NEP). Services of the NEP are available for everyone free of charge. For the time being several tens of thousands learning objects can be found on the NEP (https://www.nkp.hu/), being developed continuously, including interactive tasks, animations and films.

[[END OF PAGE 12]]

[[START OF PAGE 13]]

Textbooks and workbooks developed in the framework of the state-funded educational textbook development program are also available on the portal. The new textbooks are also available in a smart-book format containing interactive tasks, animations and videos besides the basic textbook contents.
...
According to 18/2016. (VIII. 5.) Ministry of Human Capacities Decree : education on sustainable development is a horizontal requirement in all higher education trainings.
...
National Framework Strategy for Sustainable Development 2012-2024;

National Strategy on Environmental Education;

National Sustainable Development Frame Strategy;

National Sustainable Development Strategy;

National Sustainable Development Strategy Second Progress Report;

Hungarian National Lifelong Learning Strategy: http://www.nefmi.gov.hu/download.php?docID=592 (in English)

[[END OF PAGE 13]]

[[START OF PAGE 14]]

Hungarian National Youth Strategy:

https://www.youthpolicy.org/national/Hungary_2009_National_Youth_Strategy.pdf  (in English)

Hungarian Higher Education medium-term Strategy: 'A Change of Pace in Higher Education': https://stip.oecd.org/stip/policy-initiatives/2017%2Fdata%2FpolicyInitiatives%2F5508 (summary in English)

Act CCIV of 2011 on National Higher Education;

4th National Environmental Program (2015-2020);

National Development 2030 - National Development and Territorial Development Concept;

Second Climate Change Strategy of Hungary for 2014-2025 with an outlook to 2050;

National Strategy for the Conservation of Biodiversity in 2015-2020:

National Nature Conservation Master Plan (2015-2020);

National Rural Development Strategy 2012-2020;

National Water Strategy (2017-2020-2030);

National Forestry Strategy 2016-2030;
...
https://digitalisjoletprogram.hu/files/0a/6b/0a6bfcd72ccbf12c909b329149ae2537.pdf in English);

The Digital Child Protection Strategy of Hungary:

https://digitalisjoletprogram.hu/files/c2/61/c2610c5560ef56425860d4d7bdd68b3d.pdf  (in English);

National Educational Portal: https://www.nkp.hu/
...
--- | --- | --- | --- | ---
National
Design or revision of the curricula | 1 | 1 | 1 | 9
Setting of programme learning objectives | 1 | 1 | 1 | 9
Textbook development | 0 | 1 | 0 | 9
Teacher education and training | 1 | 1 | 1 | 9
Assessment of student outcomes | 0 | 1 | 1 | 9
Sub-national
...
Pre-primary education is based on the National Curriculum of Kindergarten Education in Hungary. This document establishes development areas, which include: health and (social and personal) well-being  and  emotional,  moral,  and  value-oriented  community  education  (which  contains elements of GCED and ESD) with a focus on the appreciation of the values. The activity areas include learning about the environment.

In primary and secondary education, a three-level structure constitutes the overall framework for curricular matters:

· The National Core Curriculum (NCC) is issued as a government decree. It provides the basic principles, specifies the obligatory and common objectives of the educational/teaching work performed in the general (non-vocational) phase of education. It focuses on the acquisition of key competences required for lifelong learning. It is the most important document regulating the content of the public education system. It contains the  development  fields,  educational  goals,  and  the  tasks  and  values  of  the  national education system and the content of subject areas.

· It  is  the  Framework Curricula, which elaborate the implementation of the NCC.  Several  framework  curricula are provided centrally for the different educational contexts. They serve as a basis for developing the Local Curricula.

- At institutional level, local curricula are developed by schools in accordance with  the  stipulations  of  NCC  and  the  relevant  Framework  Curricula.  The  local curriculum takes into account the local circumstances and conditions.

The NCC has gone through a thorough revision, being introduced in a yearly schedule starting in September 2020 on grades 1, 5 and 9. It prescribes the full respect for human rights throughout the whole education cycle including the respect for equality, democracy and religious  diversity  as  well  as  the  knowledge  of  basic  concepts  concerning  gender equality and anti-discrimination.

An important part of the desirable attitude to be shaped is to overcome personal prejudice. Among the twelve most important development fields and educational goals defined in the modified NCC you can find 'Education for citizenship and democracy'; and also 'Education for sustainability and environment consciousness' Consequently these educational goals must be represented to a certain extent in each school subject.

School subjects like History and Civic Studies are special in respect of GCED as they provide the best channels for creating democratic commitment in a targeted way.  Basic principles  and  goals  of  teaching  History  include  making  students  familiar  with  the operations of a democratic state organization, the principles of the rule of law, human rights and aware of citizens' rights and responsibilities.

Gender equality is among the so called 'comprehensive' topics in History, which means that the issues concerning men's and women's lifestyles, social status, and emancipation are to be tackled in a recurring way during the whole teaching-learning process.

An invention of the revised NCC is making 'Civic studies' on grades 8 and 12 a separate and compulsory school subject as opposed to the previous version of the curriculum when civic  studies  used  to  be  integrated  into  History.  This  modification  represents  the importance of the topics incorporated into Civic studies, such as the importance of equal opportunities and social justice, the essence of the prohibition of discrimination and the realization  of  the  negative  impact  and  social  risks  of  discrimination,  stereotypes  and prejudice.
...
The new NCC places the task of developing a commitment to a sustainable future among its learning and educational goals making an impact on the entire educational process in public institutions. Under the new NCC, schools need to support students in developing their sense of responsibility for the environment and the future of our communities beyond the daily practice of learning and community life, by organizing whole-institutional project days and thematic weeks, by programs calling for students' collaboration and activities, and by involvement in local, regional, national, and international programs.
...
The NCC requirements will be included in the subject-based frame curricula developing subject-specific knowledge and competences related to ESD (especially strong in History, Geography, Biology, Physics and Chemistry, but also present in all subject areas). This will ensure that the horizontal educational objectives set out in the NCC, including ESD, can be achieved by general (public) education institutions in a sufficiently diverse way, embedded  in  a  variety  of  learning  and  teaching  activities,  using  a  combination  of approaches across subjects and disciplines. Besides, a new subject Sustainability is under development for secondary schools, which can establish school-leaving examinations in this field.

GCED  and  ESD  are  incorporated into the curricula of several Hungarian HEIs. The 'Environmental  sustainability  expert'  and  'Regional  and  environmental  economics'  study programmes are integral parts of the 'offer list' of the Hungarian tertiary education.  The majority of  Hungarian  HEIs  offer  further  standalone  subjects  along  the  concepts  of  GSED  and  ESD. Several Hungarian universities operate competence centers that deliver SDG related research activity.
...
##### Excerpts from the National Curriculum of Kindergarten Education:

'2.  The  child,  while  discovering  their  environment,  acquires  experiences  that  are necessary for safe orientation and orientation in the environment, appropriate to their age. They get to know the homeland, the people living there, the domestic landscape, the local traditions and customs, customs, belonging to the community, the values of the national, family and material culture, they learn to love and protect them.'

'4.  In  kindergarten  education,  the  principle  is  that:  (a)  the  personality  of  the  child  is surrounded by acceptance, respect, love, respect and trust; (b) education enables and facilitates the development of the child's personality and the development of the child's individual  skills  and  abilities;  (c)  the  pedagogical  effects  used  in  pre-school  education should be tailored to the child's personality.

5.  In  order  to  implement  the  principles,  pre-school  education  ensures:    (…)  the transmission of human values; about the personal and material environment necessary for the healthy development and development of the child.
...
'The document focuses on cross-cutting issues around the world, emphasizing shared responsibility for sustainability.'

'Key development task: Sustainability, environmental awareness The rising generation needs to know and appreciate the rich diversity of life forms in nature and culture. They need to learn to use resources consciously, sparingly and responsibly, given their ability to innovate. The aim is to shape behaviours of students so that environmentally conscious, value-based, and sustainable behaviour based on knowledge and the love of nature and the environment becomes pre-dominant. The educational institution must prepare them to exercise their civic duties and rights in relation to the environment. Efforts should be made to make students aware of the economic and the social processes that can cause changes and  crises,  and  to  get  involved  in  the  preservation  and  enrichment  of  the  values  and diversity of their immediate and wider environment.'

'Science  and  technology  competence  includes  the  knowledge  of  the  conditions  for sustainability,  i.e.  a  society  that  is  in  harmony  with  nature  in  the  long  term  and  the recognition of the individual and community responsibility for shaping it.'

'Positive  attitudes  are  based  on  full  respect  for  human  rights,  including  equality, democracy, religious and ethnic diversity. A positive attitude towards a sense of belonging to  a  municipality,  a  country,  a  nation,  the  EU  and  Europe  in  general,  an  openness  to participate at all levels of democratic decision-making, and a sense of responsibility and acceptance  of  and  respect  for  common  values  and  democratic  principles  declaration. Creative  participation  also  means  civic  activities,  the  promotion  of  social  diversity  and cohesion, as well as sustainability, and respect for the values and privacy of others.'

Government  Decree  no.  363/2012.  of  XII.  17.  on  the  National  Curriculum  of  Kindergarten Education;

National Core Curriculum: Gov. decree no. 110/2012 of I. 31;

The Globalization Competence Center of Széchenyi István University carries out interdisciplinary research in the field of the education of the SDGs.  The key priority of the Automation Research Center of Széchenyi István University is the observation of the SDGs.
...
History | 1 | 1 | 1 | 1 | 0 | 0 | 1 | 1
Languages | 9 | 9 | 9 | 9 | 9 | 9 | 9 | 9
Mathematics | 9 | 9 | 9 | 9 | 9 | 9 | 9 | 9
...
3.3 | respect for human rights and fundamental freedoms (as outlined in international conventions and declarations) | 0 | 1 | 1 | 9
...
According to the 8/2013. (I. 30.) Ministry of Human Capacities Decree on common requirements for teacher training and on training and output requirements for individual teacher professions carries most of the contents referred to in point C3.

Higher education institutions shall deliver programmes on the basis of an educational programme. As part of their educational programmes, higher education institutions shall develop the curricula for bachelor, master and tertiary vocational programmes in accordance with the programme and outcome  requirements  issued  by  the  minister,  and  freely  for  postgraduate  specialisation programmes.

There is no pre-prescribed educational content for those who teach in higher education, because teacher  qualification  is  not  a  condition  for  teachers  teaching  in  Hungarian  higher  education. Institutions may require training on their own in both above mentioned subjects, but there is no central regulation in this area. That is the reason we cannot give more specific information about the tertiary education in C2 point and further.

The  following  training  courses  offered  at  Eszterházy  Károly  University  (EKU)  to  all  teachers, trainers and educators: Field of studies where GCED is included as a specialization within the education field:
...
Mandatory course to all teacher training programs students where GCED is mainstreamed:

- Psychology of cognition and Individual Treatment of Learners,

Elective courses for teacher training programs where GCED is featured :

- Conflict Resolution and Management,

- Multicultural Education,

- Learning Difficulties and Developmental Procedures,
...
Training courses for teachers where GCED is included:

- Differentiation and Development Methods,

- Methods in socio-therapy for anger management in schools.

Field of studies where ESD is featured as a specialization within the education field:

- Environmental Science Teacher,

- Sustainable Environment and Resources Management,

- Environmental Economic Studies,

- Environmental Physics,

- Environmental Problems in Geospheres.

##### Semmelweis University
Our educators at Semmelweis University are not required to receive training to teach GCED and ESD. It must be clarified that they are practically not teachers per se but  rather  researchers  and  medical  professionals  at  the  same  time  who  are  also  performing teaching. Currently, these educators receive a non-obligatory teacher training course which is focusing on  the  teaching  methods  and  on  infocommunicational  technologies.  However, Semmelweis  University  is  currently  involved  in  an  ERASMUS+  project  called  CLILMED (https://clilmed.eu)  which  aims  to  provide  guidebooks  for  teachers  on  how  to  the  deal  with intercultural  classrooms  thus  this  aspect  is  going  to  be  included  in  our  staff  development programmes in the near future.
...
GCED and ESD is mainly taught to specialized teachers.

##### University of Nyíregyháza
There is a training or a lecture for the instructors every year.

##### Széchenyi University:
'Education for sustainability and health' is a mandatory course of the curriculum of teachers as well as social pedagogy   (BA) 'Project based environmental education' is an integral part of the training programme of primary school and nursery students.

##### University of Szeged
In  the  initial  trainings  of  the  teachers,  trainer  and  educators  the  above areas are usually mainstreamed.

In  continuing  professional  development  of  teachers,  trainers  and  educators,  it  is  basically implemented in two ways, within formal and non-formal settings, that is further education and further trainings to develop personally and professionally, to broaden teacher's knowledge and experiences to keep up with needs. Formal training is required in some disciplines or in some fields of specialization in relation to those areas mentioned in the question, and is recommended in other disciplines and fields of specialization.
...
At  the  level  of  initial  training,  at  the  Faculty  of  Humanities  and  Social  Sciences,  University  of Szeged, Hungary, students are exposed to GCED and ESD topics through courses related to culture,  cultural  studies,  linguistics,  literature,  modern  languages,  history,  philosophy  and sociology.  The  GCED  and  ESD  apply  to  the  initial  training  and  continuous  professional development of teachers and trainers. The course description of each training includes how the perception of sustainable development can be realized during the given seminar and / or lectures.

These two aspects also appear in the general objectives of National Core Curriculum and the related framework curricula, which are the basic documents of Hungarian public education.
...
###### Knowledge
The  graduate  /  qualified  teacher  has  basic  psychological,  pedagogical  and sociological knowledge of views on personality traits and development, socialization and personalization, disadvantaged children and teenagers, personality development disorders, causes  of  behavioural  problems,  methods  of  parenting,  talent  management,  and  health promotion. Knows  the methods of getting to know  learners. Knows  the special competencies to be developed during the teaching and learning of the subject, the methods of their development and diagnostic measurement. He is aware of the role and possibilities of the subject in the personal development of the students.

###### Abilities
The graduated teacher is able to form a realistic picture of the world of children and teenagers, the possibilities of education and the development of the learner's personality. Able to create pedagogical situations, taking into account the individual needs of learners, which promote the intellectual, emotional, social and moral development of them and the establishment of a healthy lifestyle. He / She is able to choose appropriate methods for learning and for developing learners with different abilities and prior knowledge. He / She is able  to  recognize,  effectively  educate  and  provide  differentiated  treatment  to  talented learners  as  well  as  to  learners  with  difficulties  or  with  special  educational  needs, disadvantaged, multiple disadvantaged learners and learners with special needs in their subject.

###### Attitudes
A  qualified  teacher  is  open  to  learning  a  variety  of  methods  of  personality development. He / She respects the personality of the learners, is able to see the values in everyone and to treat all his / her learners with positive emotions. He / She is sensitive to learners' problems, strives to provide the conditions for healthy personality development for all learners.

The aim of the  teacher training  in  Hungary  is  to  develop  the  8  key  competencies  of  teacher candidates, of which we would like to highlight the knowledge, skills and attitudes acquired in the following areas:
...
###### Complex basic program (KAK):
The Complex Basic Program is a set of personality and ability development activities that include a set of complex pedagogical methods for increasing (learning) opportunities. The program builds on the diversity and uniqueness of students, the development of  individual  skills  through  social  interactions,  which  means  support  in  the  teaching-learning process and in the preventive reduction of school dropouts without qualifications. The primary goal of the Complex Basic Program is to develop and disseminate pedagogical methods suitable for  the  prevention  of  students  dropping  out  of  school,  for  supporting  teachers  in  primary  and secondary education, and for renewed teacher training and in-service training content to facilitate the change of pedagogical attitudes. It also aims to nurture talent and find individual learning paths.  A  further  aim  of  the  program  is  to  strengthen  the  methodological  culture  enabling differentiated, person-centered  education  in  public  education  institutions,  to  develop  the pedagogical and methodological tools of institutional education that encourages openness, and to create a fair, equal learning environment for the successful progress of all students.

The service portfolio of the Complex Basic Program includes 7 accredited (free of charge) teacher training  programs:  Complex  Basic  Program  Concept  (KAK),  Differentiated  development  in heterogeneous groups of students methodological training (DFHT), Logic-based subroutine (LA), Digitally Based Subprogram (DA), Life Practice Subprogram (CA), Arts-Based Subprogram (MA), Exercise-based subprogram (TA).

Two of our trainings are basic training: Complex Basic Program Concept (KAK) and Differentiated development in heterogeneous groups of students methodological training (DFHT)

##### Semmelweis University

We  have  an  obligatory  environmental  awareness  course  of  the  Directorate  of  Security Service of Semmelweis University for all new employees

[[END OF PAGE 24]]

[[START OF PAGE 25]]

(https://semmelweis.hu/biztonsag/uj-belepo-oktatas/). In this course the concept of environmental sustainability is thoroughly addressed.

##### University of Nyíregyháza

BAI002 Environment and Human course KO1111 The Practice of Multicultural Education UPX1105L Multicultural Education

##### University of Szeged

One of the best examples is the University's mentoring program, which aims to help students successfully graduate with a variety of tools, to reduce or mitigate any gaps through catch-up programs, to support students' high-quality daily life, and to guide them in the labor market. In order to be able to help students as effectively and efficiently as possible, teachers, trainers and educators  in  the  mentoring  program  continuously  participate  in  further  trainings,  forums  and workshops,  and  share  their  good  experiences  and  collaborate  with  the  Student  Counselling Centre of the University of Szeged.

Another good example is the 'curriculum and subject development based on learning outcomes' (in short: the 'learning outcomes' approach) introduced at the University. In order to encourage and foster  practical  implementation  of  the  initiative,  teachers,  trainers  and  educators  involved participated  in  trainings,  forums,  and  workshops  where  they  received  support  for  successful implementation.  All  this  can  greatly  contribute  to  the  improvement  of  the  effectiveness  and efficiency of education, and thus to the mainstreaming of the content of terms in question.

In addition to the above, another good is example should also be noted: the training of Curriculum and curriculum development based on learning outcomes in higher education.

At  the  Faculty  of  Humanities  and  Social  Sciences,  courses  like  Introduction  to  Literature  and Culture,  Introduction  to  Linguistics,  Introduction  to  British  and  American  Studies:  History  and Culture for Teachers, Introduction to Applied Linguistics should also be considered.

Beside these, 8/2013 (I. 30.) EMMI decree declares that the GCED and ESD must appear in teacher  training.  These  two  aspects  also  appear  in  the  general  objectives  of  National  Core Curriculum and the related framework curricula, which are the basic documents of Hungarian public education.
...
- Cooperative learning organization to prevent early school leaving

- Basics of Romology - Preventing student dropout

- Assessment to improve effectiveness in class

- Individual treatment, personal care
...
- Complex  development of learners against early school leaving without qualification - Digital-based methods

- Complex  development of learners against early school leaving without qualification - Practice-based methods

- Complex  development of learners against early school leaving without qualification - Logic-based methods

- Complex  development of learners against early school leaving without qualification - Methods based on art education
...
Crime Prevention at School The aim of the course is to prepare students for crime prevention sessions, to prepare prospective teachers on what problems they can ask for help from whom, and where they can direct students with problems. By completing the course, prospective teachers will be able to acquire theoretical and practical knowledge that will enable them to teach independently on the topic of becoming  a  perpetrator  and  victim,  and  will  also  gain  personal  experience  in

[[END OF PAGE 26]]

[[START OF PAGE 27]]

applying constructive pedagogical methods during practice-oriented training. They learn the necessary legal concepts and the most common ways to become a victim and perpetrator. Teacher candidates will be able to organize and conduct group assignments.  They  can  plan  a  crime  prevention  education  for  a  class.  In  the theoretical  part  of  the  training,  lectures  on  the  basic  legal  and  criminological knowledge related to the topic can be attended, focusing on crimes affecting young people and the recognition and treatment of domestic violence. They can learn about other areas of everyday crime prevention through group assignments and situational games. Students will be introduced to methods of teaching with crime prevention  short  films.  The  theoretical  background  of  the  practical  part  is  the acquaintance with cooperative pedagogical methods and the pedagogical practice of group work. In the second, practical part of the training, students can apply the familiar cooperative methods and group leadership techniques.

###### 6. Other programs at University of Pécs:

Inclusive University The University of Pécs Inclusive University is a value-oriented, open-minded, and inclusive organization as an intellectual workshop of the country and the region. It seeks to reinforce and extend this approach to all citizens of the University and those involved in its services. As an organizational unit, the Inclusive University,  as  an  umbrella  organization,  coordinates,  reinforces,  extends,  and coordinates  inclusive  good  practice  across  faculties  and  units.  It  facilitates  the communication  and  collaboration  of  inclusion  programs,  while  supporting  the practical  implementation  of  inclusion  through  its  own  programs,  events,  and services. The Inclusive University promotes a more successful education for UP students, prospective students and the well-being of all UP citizens by creating a diverse, inclusive university environment. By doing so, he wants to strengthen the University's individual image and focus on its local values, thereby increasing the unique position of the University of Pécs in the higher education market.
...
###### Semmelweis University
Student assessments and examinations are focusing almost exclusively on the knowledge and skills related to the actual material. However, the topics covered by the Department of Behavioral Sciences are including many aspects of the GCED and ESD. As of now, students are not assessed or tested based on their values, attitudes and/or behaviours at Semmelweis University in connection with the taught material.

###### Eötvös Loránd University
Students are assessed only on their knowledge of and skills in the formal education. But values and attitudes can be rewarded in a positive way (volunteering, researches)
...
--- | --- | --- | --- | --- | ---
National
(a) | Education laws and policies | 2 | 2 | 2 | 99
(b) | Curricula | 2 | 2 | 1 | 99
(c) | Teacher education | 2 | 2 | 1 | 99
(d) | Student assessment | 0 | 1 | 1 | 99
Sub-national
...
The system of Sector Skills Councils (SSCs) was established in 2018. SSCs serve as a platform for building partnerships with economic stakeholders. SSCs are coordinated by the Hungarian Chamber of Commerce and Industry.

The tasks of the SSCs include the continuous development and modernization of the content structure of vocational education and training (VET), as well as the coordination of training supply and labour market needs.
