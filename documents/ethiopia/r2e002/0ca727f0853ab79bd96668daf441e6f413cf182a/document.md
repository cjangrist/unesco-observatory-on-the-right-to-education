...
fh,'1'f-A-,t' &..f..I..t\'P. Jt iJ"hl.,(l"t'«r. tT,n/Lh

&of-..IraA ";J ~:,. ;J1t fI) FEDERAL NEGARIT GAZETA
...
II},,:"\'-A',t' &<>,(l,,/..I\~ .t;/I"h/../'t,J'tp' I.T,nt\.h \',1,""'} "'(1)11\':')" 9Uhc n.:" ml}'I:H' f(l)n)
...
# },(I"l>: '/:'i'C tH;'j'i./'iiir'jr, \' :h'" ,I( ::,. 1I.,r.:):':}},(III/.:~':;,: .~, i\;i:ji.r.c t\ulltn(j\u: \,(/)(,,(/).'} },(I':l>:' t\tI'fli'liA f(l)l') },(I':l>:

\'''/A :"')"UC:" 1I,.r:,)'.'} \',1,"1'11 lJ,n:,' t\l"ff:I."/ lI(I)n)OJ' }, tl':f (III 'I' I. :,. \',1,"1'11 lJ,lI :" \"",l',I."':"'} :"')",1(::" n.,r:,)'. },(lII/..C(j },(t"','Ll'.C },"/I),II ill\:':(/)' \,}","'\,'A',(' /...,{',,/..f\'P. ,1;,t,"i'/'.lt,<'tP' ;'T'flt\J, (lII'}"II":" },ill\:" },(I),4""C :JC ~,'}.t;, (')(",)" tI'/.\':1."/ IItI'/{t/.,t\',.:

\,,1""'11 :"')"UC:" II.'Y:')"\,:I'')''lJl::'' },/'tl'j'l' IIWH: },<I'(': ,l'.I.:~' fI./i'C \'tI'/:11) w,'} f:"')",1( ::,. Y.I.:~' f m 114'(j '}9"IJC'} II.'y.:,: W"/:'7.1I:" ,n,h./.,tP' i'AA (I),f',')" \'\I'I.t,'/ (/II{t".,v,,\':C \,"'III.:J(IJ"} \~:""''',I(::'' I"C~:" \',I"\I".t\ ~,'},(U/"} W"/{t/',t\'I':

1I,1t'1',1I'}"'''UC:,. II.'Y:'}" \""/./'tm(l)"} \,:"9"IJC'} i.I.'" t\tI'/"/i"""A \,tI'I.,('O'1'A: \,:"')"UC.} II.'y.:,:'} (l1I9"1J/.:} (lO,n.}lj '1':"')" \,tI'/.,f'{t\HIC ~,'},It/J'')'' 'hn:""'I. \'1""(1)' '~'nl."./'t'n \",,"""t\ },'IA"/fI."'} ftl'/.Yr~lI:" }"l'.I.:lCl>::" ~,'},~/i'C (''/.\':1.'', W',/ {t /., t\ 'I':

\':"')"UC:" II"r:,}"'} },(lII/..Ct,' },{t".,v,J'-C t\tIIltnljhC f(l)lI'W"} },tl':C>: tI'/""""""A },{t/..I\'I. 11'(j' IIl/P'n"I::

II},:}\,'A',<' /...Y../..I\t,r ,li,tI"i,/../'t..('(P. I.T,nt\.h J11 1/II'}"II:'i" },'H'~' ~(?;(?,) (111,1'1.:" ftJ'llJl'I.t\m' :J-cf)'~:A::
...
'IX' {ii'i.i'hi'i! "...1.'..1../:\ '1:)(.:" :J/l.tli 'I:','C: ".i,!;

M. ?!!i '1") n~'}'9'"

Federal Negarit Gazeta -No.47
...
- 6' f'}9"I1C:" fl.'Y:')""} ~,aD/.,Cli ~,(H'P'JJ.C t\fII!mlfh(! flmll'(I)' ~,CP:(>:' ":','C ~W:'~::O!r(f?;:

\';"'U'fl '}')"tH::" fl,'Y:''''' h£ID/.,Cli ~,{H'P'f.C,} (H'aDt\tH' t\'}')"tH::" fII!.'1.{H;Cli t\fII!.'1.().1'~, \""()mm' P'(.V,)'}I,' "'''lIJC ",'ii(~' (lIlU ~,CP:~ ~,'H'1.' i~ P'C (\'I"It\1..:" f£IDI""'P,J~:C ~,t]"t'1' "'I\A(.':~,A::

- t\) \1~,'H'1.' :r:!i~~q;: ~,'H>1.' ?!~r,: ?~'!!:~,lf «!) fl'lU ~,I,) :(>; ." 'Ii//') A::

~{ , f e),'U'fl :"')"tH::" fl,'Y':""'} ~,£ID/.,CI,~,()"'P'f.C t\fII!m li\H: fl(l)fl)m. ~,CP:(>; ,,:','C ~r~J~;n!f.(rj OOIPI.7fm("(I)' 'f en'JI.fl :"')"UC.} fl,"':"" f,~'/."";;: 1-P,f.. .e:HI (fen"l h£t:A u'I():hf)ctJJ cf:c"c 'it?;;H!f.~I) .,,'ii~:A::

## i> .e:HI f(/'/(I)'(":" p'A(')'}

f e),"'" I :" fl,'Y:'}" f(I1/:1'f.IF,:m. f.fleh,/.,'P. hAI\'P. OO'}"l P' :1':" 9"tU: fl,.y.:.,.,: ~,Ii 'hn/. '1 :":':(1). t\&of../..t\aD'}"lp':" fl1'~, fh"'(/'/ aD(),,'P,J':C ')"hC n",:"'" flfhA I\:,:m' f(/'/;1'r f a,'I,.,' '}')"tH::" fl..r:.}'.'} hOO/..Clf h()'" .'L(',C: f:"9"tJl::" ~,()(""': faD')"U/.,')'} ~,"'fI)mClf h()1' .1~.e,C f(/'/,f/ut\tH: ,(':}fl'.}",,} .emfl)t\.: f,'}(V,: flY/., I\f.. aD(I'I\:,:m"}')" (}()I\,l','1:" ,l',cY,lI,m/"t\.::

## ii. aDaU/.,e f(/'/m,(":" p'A('J'}

f-I'eh,/.,('~ tIAI\('~ aD'}"1p':"'} ~,'}P,.lJ'')'' fh"'fII! h()'" ,1~.e,C :"9"I1C:" fl.l~'9"}"' fftlAt\":J::'=(I)' ')"hC n,.y,:-", \,(IIl..e(l)/~0N''''} ,(':}(l',)", t\"'/()/..1.')" ~,()/..I\'l fin, OO£ID/' .<J9)'.}',,} (/'/(1).('):" ,l';'}"1\ t\'::

## ?;' 'hnl.;:"

fl(/'rg:m'9" M,,:I'f'A..<J /".l'../..I\(p' .I;.cP)h/.'().JJ'P./''1'111\.h tl AA (I)'iI'I' f(ll/:n', f a,'U'fl '}')"Uc.} n,.y,:}', "'m/. H' .}; fl.'y.:,: fl(/'/:Il.n:" 'fleh,/.,(P' hAI\'P. £1D'}"lY'1': mf..')" f\H,(I'/ {/"I)()""I~J':C t\(/' :1'fm, ~,"lfH1'1'} I\t\(I)' f""9" I1C'} (l.L~' ~,itA ,l',ll'liA::

## k au.fl:"li "W..:" ()t\u'I()','I\t\lt:

M,IP:(>; 'f:"'C ~v~'/nn~(~'?; aD 11'1.:" "'~N:£ID(lJ' f'1(l';,.1' \' a,'I,.,1 '}9"tH::" fl,'Y:')"'\1(/'/.":9'1' £1D.fl:"li "l.~..:" IHlU ~,q):~: {/"I"PI.:" 1J'11/,mtn-:" .e:}(l'.}', fln'I,.,1 '}')"Uc.} fl.'Y':':'} t\(/'/iI"','~.e,c t\(/V':~':/1D':" ~,ill\:" "'I\A~:A::

## ,/, I. J' ,(l,,"} :n,

\' aDli,'J'1 M,q):(>; ,,:'''C ~r~I/r:in~(;"~/; IJ"lJII.' I.:" f"'~':~':IID.'} f In 1,.,1 :" fl.'Y:'}"' \1(/'1.": 51)"}.' (11/.1' ~,q):(>; ~,,}"'1.' t (I).()", fl"',('.'1 .,.,m' aDII'I.:" fa,'U'fl :" fl.'y.:,: ~,()"'P'Y,C ;"1\/.,'1:" ffll!,() (',:,:m, ~,itl\ :" ~,MI.~':~I:(1I). ,(l,,'I.() P' /.,m"} fl '1 fll.(I)' ~,'P/..C aU/PI.:" f(/'/ittl,.Y: ;"1\;',',:" ~,t\'F':m'::
...
'/1.' ?iir.i~n t..Y../..A ,/:)/.:," :J/IJ" '/:'I'C ~~i:i, M.ri"!! 'V} :o!n~ (~'9°.Federal Negarit Gazeta -No. 47 6th July, 2000-Page 1390

## ~I;' 'h~.X (I'/.'n' \' 1'\.1'\ :/:(1). ,), ',.:.}"-

'I,/(i:/:(I)'')'' \il/,tJ 1',(,.:~: :)e \,(I'I..<t>I.~. ,k)"')" ~,(i 1',lJ,.t.(~',rnl/.tJ 1',(":(1: n'H'il..',".,Ia':,)"' I'\J'. '/'1..7..'1'/..,:,. 1',f.(:'t. :':(1).'),,::

.

## !! i'",.:~'\'(I'/.orifH' "./1.
J'.tJ1',''':(1: 1M. ?;'!! 'I"} f!WH{ (~-')" :(I:9"(~' \'O(i J'J!f(,'t.\::

i',,1t{1 1',nlJ M. ?;'j! 'I"} n!tB{ '~-9U
...
Done at Addis Ababa, this 6thday of July, 2000.

NEGASO GIDADA (DR.) PRESIDENT OF THE FEDERAL DEMOCRATIC REPUBLIC OF ETHIOPIA

.nc:~'}r, MY" tI'Hl1'1..1' .e.:c::e.::,- :"'''00 BERHANENA SELAM PRINTING ENTERPRISE
