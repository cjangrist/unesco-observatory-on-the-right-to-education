...
The ministry of education's most prominent efforts in implementing the Fourth Sustainable Development Goals can be briefly referred to as follows:

- The formation of a national committee to follow up on the implementation of the fourth goal in the Sustainable Development Plan.

This committee aims to lead efforts, develop plans and implement initiatives related to the fourth goal.

In addition to supporting the competent authorities to implement the remaining goals of the sustainable development plan, there are members of the General Administration for Early Childhood to follow up on the achievement of the Sustainable Development Goals.

Also,  many  programs  from  General  Administration  of  Student  Counselling  such  as  Bullying Prevention Program, (Rifq) program which mean gentleness and Drug prevention program.

- National Center for Educational Professional Development :

The National Center provides short-term training programs for teachers and leaders that embody global citizenship and instil values such as embedding citizenship values in education, leadership by values, inculcating values, concepts and instilling values through Islamic studies courses.
...
6. | Environmental sustainability | 9 | 1 | 1
...
The concepts included in Indicator 4-7-1 are among the concepts concerned with the education policy in the Kingdom of Saudi Arabia issued in 1969. It is stated as follows:

###### A-  Global citizenship:

Article (16): Conscious interaction with global civilizational developments in the fields of science, culture and literature, by following them and participating with them, and directing them in the interest of society and humanity for good and progress.

Article (138): Universities in the Kingdom cooperate with international universities in paying attention to scientific research, discoveries, inventions, and taking appropriate of encouragement and exchanging beneficial research.

Article (42): ): Supporting global achievements in the fields of science and arts showing that science provides a summary of the efforts of humanity in general.
...
Article (50): Providing students with another language in addition to their original language to provide them with science, knowledge, arts and useful innovations, and to work on transferring our science to other societies, and as a contribution to spreading Islam and serving humanity.

Article (112): The field of scientific research plays a positive role, which contributes to the global progress in the arts, sciences, and inventions to finding solutions appropriate to the evolving requirements of life and the trends of technology (technology).

###### B-  Gender equality and human rights:

Article (7): Belief in human dignity established by the Holy Qur'an.

Article (20): Respect for rights . In addition, the educational system in the Kingdom of Saudi Arabia is basically based on equality between men and women in all its aspects, whether it is related to the admission and enrolment mechanisms in the different academic stages, or with regard to curricula, exams, or what is related to the qualifications of teachers and lecturers, or in the scholarship program. Gender equality clearly applied.
...
https://drive.google.com/file/d/1TymMRuQyszOvlNR6FB2OFDGGeTec-Dxm/view

https://drive.google.com/file/d/1ln53knYEWE0UydMVmzBcgu1tkGhbxIMU/view

https://drive.google.com/file/d/19dMR-Of17W8pv_0icei_MRh4EyMPmLV1/view

https://drive.google.com/file/d/1k0wtlI0PAUPhzaATCTiFPYGzDa-mC4Iw/view

- Training  courses  offered  to  educators  in  entrepreneurship  training  and  learning  using  modern teaching  methods  such  as  project-based  learning,  projects  and  problem  solving.  Training  for teachers to set an example for the targeted values and to instil and reinforce them among students, promoting the values of moderation and tolerance: promote values of mastery and discipline, values of  determination  and  perseverance,  inculcating  national  principles  and  values  and  promoting patriotism, care for the Arabic language,  improvement of basic education outcomes,  promote and support a culture of innovation and entrepreneurship.
...
Assessment of student outcomes | 1 | 1 | 1
Sub-national
...
Standards for early learning development for the age of 3 to 6 years for kindergarten 2015

Teacher's guide for self-learning curriculum 2016
...
##### 1-  Khebrat: Professional development for Saudi teachers

###### (School  Leadership  Practitioner  Program  (Professional  Development  Awareness Program for School Leaders)

Khebrat family group of Saudi teachers can bring their families with them to experience life in many different countries . As education is regarded as a key driver of economic and human development, the Kingdom's Ministry of Education has been sending hundreds of teachers across the globe to experience other cultures and, in turn, refining their teaching and English language skills.

The hope is to create global-thinking citizens who can share their new teaching and learning experiences with their students once they return home .
...
- Using  electronic  knowledge  resources  and  modern  technologies  in  professional development processes.

Providing a flexible environment to link the trainees with the various training resources on a large scale in time and place.

- Developing  the  skills  and  occupants  of  educational  posts  in  the  field  of  technology applications in education and training
...
Students are assessed on knowledge, skills, values, attitudes, and behaviour  .
...
--- | --- | --- | --- | ---
National
(a) | Education laws and policies | 2 | 2 | 2
(b) | Curricula | 2 | 2 | 2
(c) | Teacher education | 2 | 2 | 2
(d) | Student assessment | 2 | 2 | 2
Sub-national
(a) | Education laws and policies | 2 | 2 | 2
(b) | Curricula | 2 | 2 | 2
(c) | Teacher education | 2 | 2 | 2
...
The Globe Environmental Program is one of the international scientific programs supported by the US National Aeronautics and Space Administration (NASA). The program is implemented in different countries through the conclusion of bilateral agreements between the United States of America and those countries.

It is an international educational scientific program. It aims to train future generations of future scientists in the field of the environment through students undertaking a set of environmental measurements and registering them in the program's database and using them in conducting environmental scientific studies.

They also exchange experts around the world and also communicate with scientists to achieve an understanding of the Earth as an integrated system.
...
The  Ministry  of  Education  has  directed  all  education  departments  in  the  regions  and provinces to accept students "Syrians" and "Yemenis" (affected by wars) who have come to the Kingdom without a visitor visa or otherwise time in all public schools for all grades.
...
They are educational channels established by the Ministry of Education and supervised by the Agency for Public Education. They are broadcast live through 23 television channels over the course of twenty-four hours, and via digital broadcast via YouTube as recorded materials. Lessons are divided for all academic subjects in various stages of public education, education, and special education.

##### 2- Synchronous platform (my school):

It is a formative platform created by the Ministry of Education, Education and Distance Education, and it is accessed through special accounts for students, teachers, school leaders and educational supervisors from all schools in public and private schools, where educational milestones have been defined for the student, teacher, school leader and educational supervisor. These symbols appear in the determinants.  A certain number, which leads to its appearance in their school drawings, and which students and teachers implement by following up on topics and following up with educators.

For male and female students, the right to continue education has been granted to every student and a student supporter, who bears the responsibility for his learning equipped with research and learning tools, and psychologically affected students have been treated through telephone counselling and family awareness of the psychological impact of Covid 19 on students.

The Kingdom of Saudi Arabia received students from some other countries affected by wars such as Yemen and Syria, where students from these countries were in public schools without any financial compensation, as they are treated equally with Saudi students without discrimination or racial differences based on race, religion, or gender or colour.
