...
Amendments translated by Jefri J. Ruchti
...
# SECTION VIII: Relations Between the Legislative Power and the Executive Power
...
This inhibition shall be effective for a period of one year following the termination of the functions on which it is based, whatever may be the reason for such termination, and  shall  include  any  other  post,  professional  or  otherwise,  even  though  not
...
Departmental budgets which are declared to be in effect shall be communicated to the Executive Power for inclusion in the general budget, as information, and to the
...
initiate their functions sixty days after their election.
