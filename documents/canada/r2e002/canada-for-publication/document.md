...
*Note on the Canada response: Education in Canada is under the exclusive jurisdiction of each of the 13 provinces and territories. Given the differences in curriculum, education policies, and frameworks across the provinces and territories, the responses to the following questions may not directly reflect the specific context of each individual jurisdiction. In particular, responses to questions requiring a numerical response in the charts below (e.g., A.2, A.4, A.5) may indicate 'unknown/not applicable' in cases where policy differs across provinces and territories, such as when a given theme is embedded in one province/territory's curriculum but not in another.
...
Examples from provinces and territories:

- New Brunswick: Although no GCED and/or ESD themes are specifically mentioned in the legislation, they are set per the minister through the curriculum.

- Saskatchewan: The Ministry of Education provides provincial curricula, policy frameworks, guidelines and funding to support schools. Boards of education in Saskatchewan are provided the authority under sections 85, 87, 176 and 184 of The Education Act, 1995 to administer, develop and manage the educational activities and policies for their school division. As a result, each of the 27 boards of education in Saskatchewan will have different policies and procedures in place concerning global citizenship education and education for sustainable development.

- Alberta: The Ministerial Order on Student Learning No. 028/2020 addresses cultural diversity and tolerance, human rights, peace, non-violence, human survival, and well-being explicitly, and which are inferred throughout. The ministerial order covers primary and secondary levels in formal education. For example, the order addresses intellectual curiosity and humility, inherited traditions, engaging with new ideas and diverse viewpoints, questioning assumptions with reason, evaluating sources of information with discernment, and applying learning in a variety of life and work situations.

- Quebec: The Quebec Education Program handles curricula for preschool, elementary, and secondary education. The program is based on skills development (in other words, students' acquisition and mobilization of resources and knowledge). It includes progression of learning for each discipline (essential knowledge and skills) as well as a learning assessment framework. Under the responsibility of the school service centres and in keeping with the subsidiarity concept under the Education Act, GCED and ESD are part of the day-to-day experience through cross-curricular competencies, broad areas of learning (including 'Environmental Awareness and Consumer Rights and Responsibilities' and 'Citizenship and Community Life'), knowledge and skills, and disciplinary content, in accordance with teachers' professional autonomy.
...
1. | Cultural diversity and tolerance | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
2. | Gender equality | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
3. | Human rights | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 9
4. | Peace and non- violence | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 9
5. | Climate change | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
6. | Environmental sustainability | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
7. | Human survival and well-being | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
8. | Sustainable consumption and production | 99 | 99 | 99 | 99 | 9 | 1 | 1 | 1
...
- New Brunswick: The 10-year Education Plan has valuing diversity as one of its main themes. The NB Curriculum Framework for Early Learning and Child Care - English is a value-based framework designed for early learning and childcare. Diversity and Social Responsibility is represented in one of the framework's four goals focused on inclusiveness and equity, democratic practices and sustainable futures.

- Ontario: The Citizenship Education Framework is designed to increase and integrate citizenship education across the curricula. Students are given opportunities to learn about what it means to be a responsible, active citizen in the community of the classroom and diverse communities (local, national, and global) to which they belong within and outside the school.

- Saskatchewan: In October 2019, the Deepening the Discussion: Gender and Sexual Diversity Toolkit was released to encourage school, family and community collaboration in support of student health and well-being. It built upon work released in 2015, Deepening the Discussion: Gender and Sexual Diversity and the Student Alliances for Gender and Sexual Diversity in Saskatchewan Schools policy statement. School boards are provided the authority under The Education Act, 1995, to develop their own policies.

- Alberta: Alberta Education Ministry Business Plan - Education infers the themes of cultural diversity and tolerance and human rights education, covering primary and secondary levels in formal education. For example, Outcome 2: First Nations, Métis and Inuit students in Alberta are successful in which the ministry works collaboratively with First Nations, Métis and Inuit
...
- New Brunswick: 10-year Education Plan: Everyone at their best (Anglophone Sector) https://www2.gnb.ca/content/dam/gnb/Departments/ed/pdf/K12/EveryoneAtTheirBest.pdf
...
Sub-national
Design or revision of the curricula | 9 | 1 | 9 | 9
Setting of programme learning objectives | 9 | 1 | 9 | 9
...
- British Columbia: The curriculum is built around developing 3 Core Competencies, including Social Awareness and Responsibility, which involves the awareness, understanding, and appreciation of connections among people, including between people and the natural environment. Social Awareness and Responsibility focuses on interacting with others and the natural world in respectful and caring ways.

- New Brunswick: The Department of Education and Early Childhood Development's (anglophone sector) - the curriculum Framework for Early Learning and Child Care - English articulates common goals, values and learning principles. The four broad goals - Well Being, Play and Playfulness, Communication and Literacies, and Diversity and Social Responsibility - are interconnected and set the context for provisions and practices The overarching goal that 'Children experience socially inclusive, culturally sensitive environments in which consideration for others and social responsibility is enacted' is further reflected in the three facets of Diversity and Social Responsibility, which are inclusiveness and equity, democratic practices, and sustainable futures support. The Portrait of a Learner identifies the competencies and attitudes learners need to develop through educational and life experiences. It will inform updates to curricula, instructional decisions, assessment practices, policy development, and professional learning.

- New Brunswick: The Department of Early Childhood Development's (francophone sector): Citizenship education is integrated in study programs or is included in courses. Social studies programs at the secondary education level suggest a general learning result: indicate attributes of an active, open, and a modern citizenship.
...
- Newfoundland and Labrador: ESD is established as a context for teaching and learning in all curricula, and ESD themes are integrated within Science curricula for Grades Kindergarten to 12.
...
- British Columbia: The Social Studies curriculum is built around fostering intercultural understanding by having all students from K-12 understand multiple perspectives on complex issues and make ethical judgements of past and present events. The goal is to foster increased understanding of different cultures and values both within and between different cultures.

- New Brunswick: In the World Issues 120 curriculum, students examine the global challenges of building a sustainable and equitable future, focusing on current issues that demonstrate these challenges. Students investigate a range of topics relevant at the time of study. The course provides opportunity for student choice within the themes of humanity, interdependence, and geopolitics.

- New Brunswick Early Childhood Development (francophone sector): New Brunswick Early Learning and Child Care Curriculum.

- Newfoundland and Labrador: ESD themes of climate change and environmental sustainability are integrated within Science 1206 curriculum.
...
- Quebec: The mainstreaming of GCED varies by curriculum. For example:

- The preschool curriculum includes a social development component to help students cultivate harmonious relationships with others (group belonging and social skills).

- In elementary schools, the Geography, History and Citizenship Education curriculum is offered in each of the six years. The curriculum allows students to construct their representation of space, time and society. More specifically, students are encouraged to understand the organization of a society in its territory, interpret change in a society and in its territory, and be open to the diversity of societies and their territories.

- In elementary and secondary schools, the linguistic, academic, and social integration curriculum prepares immigrant students for continuing their schooling in French in the regular classroom by specifying the essential learning that will allow them to acquire, as quickly as possible, knowledge of the language of interpersonal communication and specific forms of academic discourse, to understand the academic and social culture of their new environment, and to develop the appropriate behaviours and attitudes to ensure their smooth integration.
...
Religious education | 1 | 1 | 1 | 1 | 9 | 9 | 9 | 9
--- | --- | --- | --- | --- | --- | --- | --- | ---
Science | 1 | 9 | 9 | 9 | 1 | 1 | 1 | 1
...
--- | ---
GCED/ESD are taught as separate subject(s) | 1 (Varies among provinces and territories)
...
Whole school approach (e.g. GCED/ESD are integrated in the school ethos, management, governance, curriculum, teacher training, teaching practices, the learning environment and in learning experiences in the community and life outside school ) | 1 (Varies among provinces and territories)
...
- British Columbia: GCED and ESD components are integrated into all BC Teacher Education Programs (initial teacher training). Some programs have specific courses related to these topics while others thread the concepts throughout the programs.

- New Brunswick: Professional learning on global competencies (including global citizenship and sustainable development) is embedded in the implementation of new curricula. All teachers participated in a professional learning day to learn about the Portrait of a Learner, and the NB Global Competencies. School districts are provided funding to support professional learning to understand and use the global competencies. Training on the Curriculum Framework for Early Learning and Child Care-English is provided within the New Brunswick Community College's Early Childhood Education certificate program. The Department of Education and Early Childhood Education offers free, online curriculum training (30 hours) for educators working in licensed early learning and childcare facilities.

- Newfoundland and Labrador: Teachers participate in optional ESD professional learning provided by informal education partners (e.g., Learning for Sustainable Futures).

- Ontario: Teachers in publicly funded elementary and secondary schools must be members in good standing with the Ontario College of Teachers (OCT), which is responsible for the accreditation of teaching programs throughout the province and ensuring all teaching programs in Ontario follow ethical and practice standards and guidelines. GCED and ESD and embedded in several areas of the core content of Initial Teacher Education programs as outlined in the OCT's Accreditation Resource Guide.

- Alberta: Effective September 2019, Alberta introduced new and updated professional practice standards for teachers and teacher leaders. The standards align with and build on each other:
...
Teaching Quality Standard for teachers who work directly with students; Leadership Quality Standard for principals and school jurisdiction leaders; and Superintendent Leadership Quality Standard for superintendents. Competencies identified for the standards include establishing/supporting and/or ensuring inclusive learning environments and foundational knowledge about First Nations, Métis, and Inuit, for all students.

- Quebec: Sustainable development training is offered to teaching staff and educational consultants. Tools are made available to help them mainstream sustainable development and thus support students in understanding and applying the concept, addressing issues such as climate change, water, energy, deforestation, biodiversity, poverty reduction, and sustainable consumption.

Other examples:

- York University: Discussions with instructors on how to incorporate these diverse themes in the language curriculum (mainly English but using the SDGs as a thematic context).

- Learning for a Sustainable Future (LSF) trains over 2,500 teachers per year through professional development sessions contracted for by school boards and teacher federations, and accessed directly by teachers; topics include SDGs, outdoor learning, and climate change.

- Aga Khan Foundation Canada focuses its professional development workshops for educators on GCED and Gender. The classroom resource is the central focus of the workshops and is a collection of lesson plans and activities focused on GECD, the SDGs, quality of life, ESD, and action projects. Educators then continue their relationship with the organization through monthly newsletters that share short lesson plans/activities around GCED that can be used in the classroom.

- Trent University: Many aspects of GCED are addressed in a compulsory course that considers equity issues such as race and gender.
...
- o Indicator 21: New Brunswick global competencies, curriculum outcomes, achievement standards/indicators are the foundation for teacher planning (daily and long-term).
...
- www.r4r.ca, www.lsf-lst.ca/en/institutes, www.climatelearning.ca, eseinfacultiesofed.ca
...
Skills | 9 | 9 | 9 | 9
Values | 9 | 1 | 9 | 9
Attitudes and behaviours | 9 | 1 | 9 | 9
...
- British Columbia: The Ministry of Education does not have subject-specific exams and has broader Literacy and Numeracy assessments. However, all BC's assessments include authentic Indigenous content, Indigenous educators in the development, and have integrated the First Peoples Principles of Learning into all assessment development. All assessments are also evaluated for social considerations.

- New Brunswick: Assessment and evaluation are done through the subject-area outcomes and the myBlueprint tool, which is currently under implementation and supports students to track the global competencies as they develop their online portfolio.

- Ontario: The development of learning skills and work habits is an integral part of a student's learning. Educators assess, evaluate, and report on a student's achievement of curriculum expectations, including GCED and ESD themes, separately from the student's demonstration of learning skills and work habits. In many subjects and disciplines in Grades 1 to 12, the development of learning skills and work habits is further strengthened through achievement of the curriculum expectations.

- Saskatchewan: Curricular outcomes clearly show that cultural diversity and tolerance and human rights are considerations when English Language Arts (ELA) texts are selected or are developed for ELA provincial examinations. Examination questions assess curricular outcomes (e.g., ELA A30 Outcome 30.4: 'Read, demonstrate comprehension of, and apply knowledge from grade-required information and literary texts from First Nations, Métis, Saskatchewan, and Canadian authors as a basis for understanding self and the multiplicity of voices and perspectives that make up Canadian cultures'). Provincial examination questions are typically written to be gender-neutral, using terms such as 'student' or 'teacher' rather than specific names. Where this is not possible, names are chosen representing the various cultures present in Saskatchewan. Exams ensure a balance of male/female names, and gender bias is also considered.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | --- | ---
1. | Cultural diversity and tolerance | 9 | 1 | 9 | 9
2. | Gender equality | 9 | 1 | 9 | 9
...
Sub-national
(a) | Education laws and policies | 9 | 1 | 9 | 99
(b) | Curricula | 9 | 1 | 9 | 99
(c) | Teacher education | 9 | 1 | 9 | 99
(d) | Student assessment | 9 | 1 | 9 | 99
...
- Ontario: The Kindergarten to Grade 12 education system provides a range of curricula and experiential learning opportunities that increase students' awareness of skilled trades and expose students to the apprenticeship pathway, including: Science and Technology Curriculum, Grades 1 to 8, Technological Education Curriculum, Grades 9 to 12. Secondary students also have opportunities for hands-on learning through the following job skills programs: Cooperative Education (Co-op), Dual Credit Programs, Experiential Learning, Specialist High Skills Major (SHSM), and Ministry of Labour, Training and Skills Development's Ontario Youth Apprenticeship Program (OYAP). Engaging and relevant job skills programs such as cooperative education, Dual Credits, Experiential Learning, SHSM, and OYAP have contributed to improved student outcomes and an increase in the provincial graduation rate.
...
- Newfoundland and Labrador: The 5-year Adult Literacy Action Plan, launched in 2019, identifies 30 actions government and stakeholders will target to ensure Newfoundlanders and Labradorians have the opportunity to acquire and enhance literacy skills, increase their education, and improve employability, well-being, and quality of life. These actions focus on the provision of foundational skills and education, including support of Adult Basic Education, a program providing skills from the foundational level up to and including high school equivalency.

- Ontario: Adult learners have free access to all secondary courses, including courses in social studies, history, and geography; these courses provide opportunities to learn about what it means to be a responsible, active citizen in the community of the classroom and the diverse communities to which learners belong within and outside the school. Ontario elementary and
...
- York University participated in the UNHack organized by Lassonde School of Engineering at York University.

- In Trent University, teacher candidates undertake alternative setting placements that include some with GCED and ESD themes.

- The Saskatchewan Regional Centre of Expertise on ESD (http://saskrce.ca/) reaches out to communities, including K-12 schools, by hosting an annual ESD Awards event that recognizes achievement in advancing ESD goals.
...
- New Brunswick: The Department of Early Childhood Development (anglophone sector) is funding initiatives that promote action research at the school level, whereby staff who develop a proposal that demonstrates how they will implement global competencies through local projects are awarded small grants. The results of these projects are shared in a variety of ways (teacher forums, written accounts, etc.) at the district level.

- Ontario: The ministry conducted research and scans on how students' global competencies are fostered, assessed, evaluated, and reported on, as well as on related professional learning and supports for educators. The province also engaged school districts in professional development to foster global competency skills in students. Collectively, this research laid the groundwork for Ontario's approach to transferable skills: critical thinking and problem solving, innovation, creativity and entrepreneurship, self-directed learning, collaboration, communication, global citizenship and sustainability, and digital literacy.
...
- Saskatchewan Polytechnic participates in the worldwide EcoCar competition that exposes students and faculty to new technologies and challenges.
...
Pre-primary | Primary and secondary | Tertiary | Non-formal education
--- | --- | --- | --- | ---
Hosting of international meetings on GCED and/or ESD | 9 | 9 | 1 | 9
Participation in international meetings abroad on GCED and/or ESD | 9 | 9 | 1 | 1
...
The COVID-19 pandemic has affected everyone in 2020.
